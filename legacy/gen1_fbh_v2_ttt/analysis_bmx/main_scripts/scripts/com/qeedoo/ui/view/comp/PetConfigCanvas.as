package com.qeedoo.ui.view.comp
{
   ...
   public class PetConfigCanvas extends Canvas implements IBindingClient
   {
      ...
      public function PetConfigCanvas()
      {
         super();
         ...
         this.addEventListener("creationComplete",___PetConfigCanvas_Canvas1_creationComplete);
      }
      
      public static function set watcherSetupUtil(param1:IWatcherSetupUtil) : void
      {
         PetConfigCanvas._watcherSetupUtil = param1;
      }
      ...
      private function onPetChange(param1:GameEvent) : void
      {
         ...
         var _loc2_:PetFightConf = PetFightConf(_core.view.getUI(ViewManager.PANEL_PETFIGHT_CONF));
         ...
         if(pet.slotData)
         {
            ...
            {
               _data = _loc2_.getCacheConfData(pet.slotData.id);
               if(!_data)
               {
                  _data = {
                     "pid":pet.slotData.id,
               ...
               _core.nextGuide(ViewManager.PANEL_PETFIGHT_CONF,"",-1,-1,2);
      ...
      {
         var _loc2_:PetFightConf = null;
         if(pet.slotData)
         {
            _loc2_ = PetFightConf(_core.view.getUI(ViewManager.PANEL_PETFIGHT_CONF));
      ...
      {
         var _loc2_:Object = _core.data.gameData[GamePredef.TBL_PET][param1];
         if(pet)
         {
      ...
      private function _PetConfigCanvas_bindingExprs() : void
      {
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:PetConfigCanvas = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _PetConfigCanvas_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_qeedoo_ui_view_comp_PetConfigCanvasWatcherSetupUtil");
      ...
      public function ___PetConfigCanvas_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      private function _PetConfigCanvas_bindingsSetup() : Array
      {
      ...
      private function showConfDetailPanel() : void
      {
         ...
         var _loc1_:AIConfPanel = AIConfPanel(_core.view.getUI(ViewManager.POP_AI_CONFIGURE));
