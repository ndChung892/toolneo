package com.qeedoo.ui.view.compDragable
{
   ...
   public class PetArenaPanel extends DragableCanvas implements IBindingClient
   {
      ...
      {
         PetArenaPanel._watcherSetupUtil = param1;
      }
      ...
      private function _PetArenaPanel_DataGridColumn2_i() : DataGridColumn
      {
         ...
         _PetArenaPanel_DataGridColumn2 = _loc1_;
      ...
      public function ___PetArenaPanel_BasicGlowButton7_click(param1:MouseEvent) : void
      {
         openArenaHelp();
      }
      ...
      private function _PetArenaPanel_State1_c() : State
      {
         ...
         _loc1_.name = "reg";
         _loc1_.overrides = [_PetArenaPanel_SetProperty1_i(),_PetArenaPanel_SetProperty2_i(),_PetArenaPanel_SetProperty3_i(),_PetArenaPanel_SetProperty4_i()];
         return _loc1_;
      }
      ...
      public function ___PetArenaPanel_DragableCanvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaPanel_DataGridColumn1 = _loc1_;
      ...
      public function ___PetArenaPanel_BasicGlowButton4_click(param1:MouseEvent) : void
      {
      ...
      private function _PetArenaPanel_SetProperty4_i() : SetProperty
      {
         ...
         _PetArenaPanel_SetProperty4 = _loc1_;
         _loc1_.name = "width";
         _loc1_.value = 167;
      ...
      public function ___PetArenaPanel_BasicGlowButton1_click(param1:MouseEvent) : void
      {
         addFightNum();
      }
      ...
      {
         var _loc1_:Object = _core.view.getUI(ViewManager.PANEL_PETFIGHT_CONF);
         _loc1_.show();
         _loc1_.petCrossConf = {
            "f":true,
            "t":_haveTicket
      ...
      {
         var _loc1_:SetProperty = new SetProperty();
         _PetArenaPanel_SetProperty3 = _loc1_;
         _loc1_.name = "width";
         _loc1_.value = 52;
      ...
      private function showSysMsg(param1:Object, param2:int, param3:Boolean) : void
      {
         ...
         if(param3)
         {
            _core.sysMidMsg(Language.PET_ARENA_U[56] + rankGroupStr[param2] + Language.PET_ARENA_U[55] + _loc6_);
         }
      }
         ...
         if(param1)
         {
            if(_firstTimeFlag)
            {
               ...
               if(!sysMsgObject)
               {
                  ...
                  _core.remote.call("getPetArenaSysMsg",null,_loc2_,-1);
               }
            }
      ...
      {
         var _loc1_:SetProperty = new SetProperty();
         _PetArenaPanel_SetProperty2 = _loc1_;
         _loc1_.name = "width";
         _loc1_.value = 52;
      ...
      public function set award1(param1:ItemSlot) : void
      {
      ...
      private function _PetArenaPanel_bindingExprs() : void
      {
         ...
         _loc1_ = Language.PET_ARENA_U[49];
      ...
      public function ___PetArenaPanel_BasicGlowButton3_click(param1:MouseEvent) : void
      {
         getFightAward();
      }
      ...
      private function petArenaFighting(param1:Object) : void
      {
         ...
         {
            _core.remote.call("petArenaFight",null,param1.cid,[param1.rank - 1]);
         }
      }
      ...
      private function refreshCharInfo() : void
      {
         ...
         var _loc1_:int = int(rankAwardCoef[_selfData.rid]);
         if(!_loc1_)
         {
            _loc1_ = int(rankAwardCoef[0]);
         }
         var _loc2_:Number = _loc1_;
         var _loc3_:Number = Math.round(_loc1_ * Math.pow(1.02,99));
         award1.toolTip = Language.AI_CONF_PANEL_U[16].replace("{min}",_loc2_).replace("{max}",_loc3_);
         _loc2_ = Math.round(_loc1_ * Math.pow(1.02,100));
         _loc3_ = Math.round(_loc1_ * Math.pow(1.02,149));
         award2.toolTip = Language.AI_CONF_PANEL_U[17].replace("{min}",_loc2_).replace("{max}",_loc3_);
         _loc2_ = Math.round(_loc1_ * Math.pow(1.02,150));
         _loc3_ = Math.round(_loc1_ * Math.pow(1.02,189));
         award3.toolTip = Language.AI_CONF_PANEL_U[18].replace("{min}",_loc2_).replace("{max}",_loc3_);
         _loc2_ = Math.round(_loc1_ * Math.pow(1.02,190));
         _loc3_ = Math.round(_loc1_ * Math.pow(1.02,199));
         award4.toolTip = Language.AI_CONF_PANEL_U[19].replace("{min}",_loc2_).replace("{max}",_loc3_);
      }
      ...
      {
         var _loc1_:SetProperty = new SetProperty();
         _PetArenaPanel_SetProperty1 = _loc1_;
         _loc1_.name = "width";
         _loc1_.value = 58;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaPanel_DataGridColumn5 = _loc1_;
         _loc1_.dataField = "cid";
         _loc1_.itemRenderer = _PetArenaPanel_ClassFactory1_c();
      ...
      private function _PetArenaPanel_bindingsSetup() : Array
      {
         ...
         {
            var _loc1_:* = Language.PET_ARENA_U[0];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _PetArenaPanel_BasicTitleCanvas1.text = param1;
         ...
         {
            _PetArenaPanel_SetProperty1.target = param1;
         ...
         {
            _PetArenaPanel_SetProperty2.target = param1;
         ...
         {
            _PetArenaPanel_SetProperty3.target = param1;
         ...
         {
            _PetArenaPanel_SetProperty4.target = param1;
         ...
         {
            _PetArenaPanel_Label1.text = param1;
         ...
         {
            _PetArenaPanel_BasicGlowButton1.label = param1;
         ...
         {
            _PetArenaPanel_Label2.text = param1;
         ...
         {
            _PetArenaPanel_BasicGlowButton2.label = param1;
         ...
         {
            _PetArenaPanel_Label3.text = param1;
         ...
         {
            _PetArenaPanel_Label4.text = param1;
         },"_PetArenaPanel_Label4.text");
         result[12] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.PET_ARENA_U[49];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            lastRank.label = param1;
         },"lastRank.label");
         result[13] = binding;
         binding = new Binding(this,function():String
         {
         ...
         {
            _PetArenaPanel_BasicGlowButton3.label = param1;
         ...
         {
            _PetArenaPanel_BasicGlowButton4.label = param1;
         ...
         {
            _PetArenaPanel_Label5.text = param1;
         },"_PetArenaPanel_Label5.text");
         result[17] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = _core.player.paPnt;
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _PetArenaPanel_BasicTxtButton6.label = param1;
         ...
         {
            _PetArenaPanel_BasicGlowButton5.label = param1;
         ...
         {
            _PetArenaPanel_BasicGlowButton7.label = param1;
         ...
         {
            _PetArenaPanel_DataGridColumn1.headerText = param1;
         ...
         {
            _PetArenaPanel_DataGridColumn2.headerText = param1;
         ...
         {
            _PetArenaPanel_DataGridColumn3.headerText = param1;
         ...
         {
            _PetArenaPanel_DataGridColumn4.headerText = param1;
         ...
         {
            _PetArenaPanel_DataGridColumn5.headerText = param1;
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:PetArenaPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _PetArenaPanel_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function ___PetArenaPanel_BasicGlowButton5_click(param1:MouseEvent) : void
      {
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaPanel_DataGridColumn4 = _loc1_;
      ...
      public function ___PetArenaPanel_BasicGlowButton2_click(param1:MouseEvent) : void
      {
         resetCD();
      }
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaPanel_DataGridColumn3 = _loc1_;
