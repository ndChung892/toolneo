package com.qeedoo.ui.view.comp
{
   ...
   public class AIConfPanel extends DragableCanvas implements IBindingClient
   {
      ...
      {
         AIConfPanel._watcherSetupUtil = param1;
      }
      ...
      public function ___AIConfPanel_BasicGlowButton1_click(param1:MouseEvent) : void
      {
         savePetConf();
      }
      ...
      private function savePetConf() : void
      {
         ...
         var _loc1_:PetFightConf = PetFightConf(_core.view.getUI(ViewManager.PANEL_PETFIGHT_CONF));
      ...
      public function showPanel(param1:int, param2:Number, param3:PetConfigCanvas, param4:Object = null) : void
      {
      ...
      public function ___AIConfPanel_DragableCanvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      private function _AIConfPanel_bindingsSetup() : Array
      {
         ...
         {
            _AIConfPanel_BasicTitleCanvas1.text = param1;
         ...
         {
            _AIConfPanel_BasicTxtButton1.label = param1;
         ...
         {
            _AIConfPanel_BasicTxtButton2.text = param1;
         ...
         {
            _AIConfPanel_BasicTxtButton3.text = param1;
         ...
         {
            _AIConfPanel_BasicTxtButton4.text = param1;
         ...
         {
            _AIConfPanel_BasicGlowButton1.label = param1;
         ...
         {
            _AIConfPanel_BasicGlowButton2.label = param1;
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:AIConfPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _AIConfPanel_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function ___AIConfPanel_BasicGlowButton2_click(param1:MouseEvent) : void
      {
         showAIHelp();
      }
