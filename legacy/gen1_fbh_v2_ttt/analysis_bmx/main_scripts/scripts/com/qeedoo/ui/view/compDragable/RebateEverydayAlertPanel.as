package com.qeedoo.ui.view.compDragable
{
   ...
   public class RebateEverydayAlertPanel extends DragableCanvas implements IBindingClient
   {
      ...
      public var _RebateEverydayAlertPanel_BasicTitleCanvas1:BasicTitleCanvas;
         ...
         "propertiesFactory":function():Object
         {
            return {
               ...
               "childDescriptors":[new UIComponentDescriptor({
                  ...
                  "id":"_RebateEverydayAlertPanel_BasicTitleCanvas1"
      ...
      public function RebateEverydayAlertPanel()
      {
         super();
      ...
      {
         RebateEverydayAlertPanel._watcherSetupUtil = param1;
      }
      
      public function buyRebateEverydayItem() : void
      {
         _core.remote.call("buyRebateEverydayItem",null,_iid);
         this.visible = false;
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:RebateEverydayAlertPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _RebateEverydayAlertPanel_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_qeedoo_ui_view_compDragable_RebateEverydayAlertPanelWatcherSetupUtil");
      ...
      private function _RebateEverydayAlertPanel_bindingsSetup() : Array
      {
         ...
         {
            _RebateEverydayAlertPanel_BasicTitleCanvas1.text = param1;
         },"_RebateEverydayAlertPanel_BasicTitleCanvas1.text");
         result[0] = binding;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.REBATE_EVERYDAY_PANEL[1];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            buy.label = param1;
