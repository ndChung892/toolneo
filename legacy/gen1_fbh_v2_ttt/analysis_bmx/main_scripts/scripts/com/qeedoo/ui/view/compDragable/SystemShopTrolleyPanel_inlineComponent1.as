package com.qeedoo.ui.view.compDragable
{
   ...
   public class SystemShopTrolleyPanel_inlineComponent1 extends Canvas implements IBindingClient
   {
      ...
      {
         SystemShopTrolleyPanel_inlineComponent1._watcherSetupUtil = param1;
      }
      ...
      private function _SystemShopTrolleyPanel_inlineComponent1_bindingExprs() : void
      {
         ...
         _loc1_ = " " + "" + Language.GAMEPREDEF_S[122];
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:SystemShopTrolleyPanel_inlineComponent1 = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _SystemShopTrolleyPanel_inlineComponent1_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function set outerDocument(param1:SystemShopTrolleyPanel) : void
      {
      ...
      public function ___SystemShopTrolleyPanel_inlineComponent1_LinkButton1_click(param1:MouseEvent) : void
      {
      ...
      private function _SystemShopTrolleyPanel_inlineComponent1_bindingsSetup() : Array
      {
         ...
         {
            var _loc1_:* = " " + "" + Language.GAMEPREDEF_S[122];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _SystemShopTrolleyPanel_inlineComponent1_LinkButton1.label = param1;
