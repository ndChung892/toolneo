package com.qeedoo.ui.view.compDragable
{
   ...
   public class LuckDrawBagPanel extends DragableCanvas implements IBindingClient
   {
      ...
      public var _LuckDrawBagPanel_BasicTitleCanvas1:BasicTitleCanvas;
      ...
      public var _LuckDrawBagPanel_DescriptionLabel1:DescriptionLabel;
      
      private var _1177985645iSlot17:ItemSlot;
      
      private var _1177985676iSlot27:ItemSlot;
      
      public var _LuckDrawBagPanel_BasicGlowButton1:BasicGlowButton;
         ...
         "propertiesFactory":function():Object
         {
            return {
               ...
               "childDescriptors":[new UIComponentDescriptor({
                  ...
                  "id":"_LuckDrawBagPanel_BasicTitleCanvas1"
                  ...
                  "id":"_LuckDrawBagPanel_DescriptionLabel1",
                  "propertiesFactory":function():Object
                  {
                     return {
                        "x":280,
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           ...
                           "id":"_LuckDrawBagPanel_BasicGlowButton1",
                           "events":{"click":"___LuckDrawBagPanel_BasicGlowButton1_click"},
                           "propertiesFactory":function():Object
                           {
      ...
      public function LuckDrawBagPanel()
      {
         super();
      ...
      {
         LuckDrawBagPanel._watcherSetupUtil = param1;
      }
      ...
      {
         _core.remote.call("getAllLuckDrawItem",null);
      }
      ...
      private function _LuckDrawBagPanel_bindingExprs() : void
      {
         var _loc1_:* = undefined;
         _loc1_ = Language.LUCK_DRAW_BAG_U[0];
         ...
         _loc1_ = Slot.SLOT_LOTTO;
         _loc1_ = Slot.SLOT_LOTTO;
         _loc1_ = Language.LUCK_DRAW_BAG_U[6];
         _loc1_ = Language.LUCK_DRAW_BAG_U[1];
         _loc1_ = Language.LUCK_DRAW_BAG_U[3];
         _loc1_ = Language.LUCK_DRAW_BAG_U[4];
      }
      ...
      override public function set visible(param1:Boolean) : void
      {
         ...
         if(visible && (Boolean(!_firstLoadCid) || Boolean(_core.player && _core.player.id && _firstLoadCid != _core.player.id)))
         {
            init();
      ...
      private function throwAllItemHandler(param1:CloseEvent) : void
      {
         if(param1.detail == Alert.YES)
         {
            _core.remote.call("throwAllLuckDrawItem",null);
         }
      }
      ...
      private function updateView() : void
      {
         ...
         while(_loc1_ < 50)
         {
            ...
            if(Boolean(_loc1_ < itemAC.length) && Boolean(itemAC[_loc1_]) && Boolean(itemAC[_loc1_].ti) && Boolean(itemAC[_loc1_].ii) && Boolean(itemAC[_loc1_].n))
            {
               itemAC[_loc1_].sIndex = _loc1_;
               this["iSlot" + _loc1_].type = itemAC[_loc1_].ti;
               this["iSlot" + _loc1_].giid = itemAC[_loc1_].ii;
               this["iSlot" + _loc1_].stackNum = itemAC[_loc1_].n;
               this["iSlot" + _loc1_].quality = itemAC[_loc1_].q;
               this["iSlot" + _loc1_].slotData = itemAC[_loc1_];
               if(itemAC[_loc1_].ti == GamePredef.TBL_CREATURE)
               {
                  this["iSlot" + _loc1_].setStyleName(_core.basic.colorByGrowRate(itemAC[_loc1_].q / 10));
               }
               else
               {
                  _loc4_ = _core.data.getGameData(itemAC[_loc1_].ti,itemAC[_loc1_].ii);
                  (_loc4_) && _loc4_.color && this["iSlot" + _loc1_].setStyleName(_loc4_.color);
               }
            }
            _loc2_ = 50 - itemAC.length;
            _loc3_ = _core.view.getUI(ViewManager.PANEL_LUCK_DRAW);
            if(_loc3_)
            {
               _loc3_.allCount = _loc3_.chanceCount / 100 > _loc2_ ? _loc2_ : _loc3_.chanceCount / 100;
               _loc3_.luckDrawButtonAll.toolTip = Language.LUCKDRAWPANEL_U[13].toString().replace("{num}",_loc3_.allCount);
            }
            _loc1_++;
         }
      }
      ...
      private function init() : void
      {
         ...
         _core.remote.call("getLuckDrawBag",null);
         addSlotListener();
      }
      ...
      private function dClickHandler(param1:GameEvent) : void
      {
         ...
         if(Boolean(_loc2_ && _loc2_.slotData) && Boolean(!ToolKit.isEqual(_loc2_.giid,-1)) && !ToolKit.isEqual(_loc2_.type,-1))
         {
            _loc3_ = int(_loc2_.slotData.sIndex);
            _core.remote.call("getSingleLuckDrawItem",null,_loc3_);
         }
      }
      ...
      private function luckDrawBagSort() : void
      {
         if(ToolKit.isSmallOrEqual(ToolKit.minus(new Date().time,_click),1500))
         {
            return;
         ...
         _click = new Date().time;
         _core.remote.call("luckDrawBagSort",null);
      }
      
      public function ___LuckDrawBagPanel_BasicGlowButton1_click(param1:MouseEvent) : void
      {
         init();
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:LuckDrawBagPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _LuckDrawBagPanel_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_qeedoo_ui_view_compDragable_LuckDrawBagPanelWatcherSetupUtil");
      ...
      private function _LuckDrawBagPanel_bindingsSetup() : Array
      {
         var binding:Binding = null;
         var result:Array = [];
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCK_DRAW_BAG_U[0];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LuckDrawBagPanel_BasicTitleCanvas1.text = param1;
         },"_LuckDrawBagPanel_BasicTitleCanvas1.text");
         result[0] = binding;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCK_DRAW_BAG_U[6];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LuckDrawBagPanel_DescriptionLabel1.text = param1;
         },"_LuckDrawBagPanel_DescriptionLabel1.text");
         result[51] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCK_DRAW_BAG_U[1];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LuckDrawBagPanel_BasicGlowButton1.label = param1;
         },"_LuckDrawBagPanel_BasicGlowButton1.label");
         result[52] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCK_DRAW_BAG_U[3];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            getAll.label = param1;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCK_DRAW_BAG_U[4];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
