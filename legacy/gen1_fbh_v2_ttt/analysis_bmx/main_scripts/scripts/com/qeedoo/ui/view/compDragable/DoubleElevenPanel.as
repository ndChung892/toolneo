package com.qeedoo.ui.view.compDragable
{
   ...
   public class DoubleElevenPanel extends DragableCanvas implements IBindingClient
   {
      ...
      {
         DoubleElevenPanel._watcherSetupUtil = param1;
      }
      ...
      public function superLuckDrawShow(param1:Object, param2:int) : void
      {
         ...
         if(Boolean(param1.p) && Boolean(param1.p > 10) && param1.type == 3)
         {
            ...
            _loc3_ = Language.NOTICE_INFO[93];
            if(!_loc3_)
            {
               return;
            }
      ...
      public function onGetDoubleElevenData(param1:Object) : void
      {
         ...
         if(param1)
         {
            ...
            chanceLeft = int(param1.lp);
            if(chanceLeft < 0)
            {
               chanceLeft = 0;
            }
            if(param1.sp != null && !isNaN(param1.sp))
            {
               allPoints = int(param1.sp);
               onceRemainCount2.text = Language.LUCKDRAWPANEL_U[19] + allPoints;
            }
            if(param1.sk != null && !isNaN(param1.sk))
            {
               keyNum = int(param1.sk);
            ...
            luckDrawAward = param1.lotteryAward;
            highestAwardArr = new Array();
            highestAwardArr = param1.hAwardLott;
            _loc2_ = 2;
            while(_loc2_ <= 2)
            {
               _arr = new Array();
               ...
               while(_loc4_ < 10)
               {
                  _loc5_ = _core.data.gameData[GamePredef.TBL_PLAN][luckDrawAward[_loc2_ - 2][_loc4_]];
                  if(_loc5_)
                  {
                     _arr.push(luckDrawAward[_loc2_ - 2][_loc4_]);
      ...
      private function _DoubleElevenPanel_bindingExprs() : void
      {
         ...
         _loc1_ = Language.LUCKDRAWPANEL_U[21];
         ...
         _loc1_ = Language.LUCKDRAWPANEL_U[14];
         _loc1_ = ResManager.hash(ResManager.getIconUrlNoHash(3130090000055));
         _loc1_ = Language.LUCKDRAWPANEL_U[16] + chanceCount;
         _loc1_ = Language.LUCKDRAWPANEL_U[19] + allPoints;
         _loc1_ = Language.LUCKDRAWPANEL_U[20] + keyNum;
         _loc1_ = Language.LUCKDRAWPANEL_U[15];
         _loc1_ = Language.VIPSHOPPANEL_U[3];
         _loc1_ = Language.LUCKDRAWPANEL_U[22];
      }
      ...
      public function set keyNum(param1:int) : void
      {
         var _loc2_:Object = this._1134689113keyNum;
         if(_loc2_ !== param1)
         {
            this._1134689113keyNum = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"keyNum",_loc2_,param1));
         }
      }
      
      public function set onceRemainCount2(param1:RoundedLabel) : void
      {
         var _loc2_:Object = this._306362288onceRemainCount2;
         if(_loc2_ !== param1)
         {
            this._306362288onceRemainCount2 = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"onceRemainCount2",_loc2_,param1));
         }
      }
      ...
      public function onOnceClick() : void
      {
         ...
         if(chanceCount >= 1)
         {
            ...
            _core.remote.call("fLotteryByClient",new Responder(start2),_loc1_);
         }
         else
         {
            luckDrawButtonOnce.enabled = true;
      ...
      private function _DoubleElevenPanel_bindingsSetup() : Array
      {
         ...
         {
            var _loc1_:* = Language.LUCKDRAWPANEL_U[21];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _DoubleElevenPanel_BasicTitleCanvas1.text = param1;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCKDRAWPANEL_U[14];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCKDRAWPANEL_U[16] + chanceCount;
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCKDRAWPANEL_U[19] + allPoints;
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            onceRemainCount2.text = param1;
         },"onceRemainCount2.text");
         result[8] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCKDRAWPANEL_U[20] + keyNum;
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            onceRemainCount3.text = param1;
         },"onceRemainCount3.text");
         result[9] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCKDRAWPANEL_U[15];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _DoubleElevenPanel_RoundedLabel4.text = param1;
         ...
         {
            _DoubleElevenPanel_RoundedLabel5.text = param1;
         },"_DoubleElevenPanel_RoundedLabel5.text");
         result[11] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LUCKDRAWPANEL_U[22];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _DoubleElevenPanel_Text1.text = param1;
      ...
      public function set onceRemainCount3(param1:RoundedLabel) : void
      {
         var _loc2_:Object = this._306362289onceRemainCount3;
         if(_loc2_ !== param1)
         {
            this._306362289onceRemainCount3 = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"onceRemainCount3",_loc2_,param1));
         }
      }
      ...
      public function ___DoubleElevenPanel_DragableCanvas1_creationComplete(param1:FlexEvent) : void
      {
         initView();
      }
      ...
      public function superLotterySystemSay(param1:Object) : void
      {
         ...
         if(Boolean(param1.p) && param1.p > 10)
         {
            ...
            _loc2_ = Language.NOTICE_INFO[93].toString().replace("※","");
            if(!_loc2_)
            {
               return;
            }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:DoubleElevenPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _DoubleElevenPanel_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function set chanceLeft(param1:int) : void
      {
         var _loc2_:Object = this._2048290139chanceLeft;
         if(_loc2_ !== param1)
         {
            this._2048290139chanceLeft = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"chanceLeft",_loc2_,param1));
         }
      }
      ...
      public function set allPoints(param1:int) : void
      {
         var _loc2_:Object = this._522238492allPoints;
         if(_loc2_ !== param1)
         {
            this._522238492allPoints = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"allPoints",_loc2_,param1));
         }
      }
      ...
      public function onGetKey(param1:Object) : void
      {
         if(!param1)
         {
            return;
         ...
         if(1 == param1.type)
         {
            chanceCount = param1.ln;
            onceRemainCount.text = Language.LUCKDRAWPANEL_U[16] + chanceCount;
         }
         else if(2 == param1.type)
         {
         }
         chanceLeft = int(param1.lp);
         if(chanceLeft < 0)
      ...
      public function set leftTxt(param1:Label) : void
      {
         var _loc2_:Object = this._55433449leftTxt;
         if(_loc2_ !== param1)
         {
            this._55433449leftTxt = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"leftTxt",_loc2_,param1));
         }
      }
