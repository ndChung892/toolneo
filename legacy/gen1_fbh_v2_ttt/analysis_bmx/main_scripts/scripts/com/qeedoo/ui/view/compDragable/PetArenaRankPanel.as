package com.qeedoo.ui.view.compDragable
{
   ...
   public class PetArenaRankPanel extends DragableCanvas implements IBindingClient
   {
      ...
      {
         PetArenaRankPanel._watcherSetupUtil = param1;
      }
      
      private function _PetArenaRankPanel_DataGridColumn1_i() : DataGridColumn
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn1 = _loc1_;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn3 = _loc1_;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn5 = _loc1_;
         _loc1_.dataField = "id";
         _loc1_.width = 40;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn7 = _loc1_;
         _loc1_.dataField = "name";
         _loc1_.width = 100;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn9 = _loc1_;
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:PetArenaRankPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _PetArenaRankPanel_bindingsSetup();
         watchers = [];
         target = this;
      ...
      private function _PetArenaRankPanel_bindingsSetup() : Array
      {
         ...
         {
            var _loc1_:* = Language.PET_ARENA_RANK_U[0];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _PetArenaRankPanel_BasicTitleCanvas1.text = param1;
         ...
         {
            _PetArenaRankPanel_DataGrid1.dataProvider = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn1.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn2.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn3.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn4.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGrid2.dataProvider = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn5.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn6.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn7.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn8.headerText = param1;
         ...
         {
            _PetArenaRankPanel_DataGridColumn9.headerText = param1;
         },"_PetArenaRankPanel_DataGridColumn9.headerText");
         result[11] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.PET_ARENA_RANK_U[7];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _PetArenaRankPanel_Button1.label = param1;
         ...
         {
            _PetArenaRankPanel_BasicTxtButton1.label = param1;
      ...
      private function _PetArenaRankPanel_bindingExprs() : void
      {
         ...
         _loc1_ = Language.PET_ARENA_RANK_U[0];
         ...
         _loc1_ = Language.PET_ARENA_RANK_U[7];
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn6 = _loc1_;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn8 = _loc1_;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn4 = _loc1_;
         _loc1_.dataField = "level";
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaRankPanel_DataGridColumn2 = _loc1_;
         _loc1_.dataField = "tName";
         _loc1_.width = 100;
      ...
      public function ___PetArenaRankPanel_Button1_click(param1:MouseEvent) : void
      {
      ...
      public function ___PetArenaRankPanel_DragableCanvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
   }
