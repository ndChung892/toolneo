package com.qeedoo.ui.view.compDragable
{
   ...
   public class PetArenaPrevRankActivityPanel extends DragableCanvas implements IBindingClient
   {
      ...
      {
         PetArenaPrevRankActivityPanel._watcherSetupUtil = param1;
      }
      ...
      private function _PetArenaPrevRankActivityPanel_DataGridColumn4_i() : DataGridColumn
      {
         ...
         _PetArenaPrevRankActivityPanel_DataGridColumn4 = _loc1_;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaPrevRankActivityPanel_DataGridColumn2 = _loc1_;
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:PetArenaPrevRankActivityPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _PetArenaPrevRankActivityPanel_bindingsSetup();
         watchers = [];
         target = this;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaPrevRankActivityPanel_DataGridColumn1 = _loc1_;
      ...
      {
         var _loc1_:DataGridColumn = new DataGridColumn();
         _PetArenaPrevRankActivityPanel_DataGridColumn3 = _loc1_;
      ...
      private function _PetArenaPrevRankActivityPanel_bindingsSetup() : Array
      {
         ...
         {
            var _loc1_:* = listLang[showId];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _PetArenaPrevRankActivityPanel_BasicTitleCanvas1.text = param1;
         ...
         {
            _PetArenaPrevRankActivityPanel_DataGridColumn1.headerText = param1;
         ...
         {
            _PetArenaPrevRankActivityPanel_DataGridColumn2.headerText = param1;
         ...
         {
            _PetArenaPrevRankActivityPanel_DataGridColumn3.headerText = param1;
         ...
         {
            _PetArenaPrevRankActivityPanel_DataGridColumn4.headerText = param1;
      ...
      private function initRank(param1:Object) : *
      {
         var _loc2_:int = 0;
