package com.qeedoo.ui.view.compDragable
{
   ...
   public class FairyManagerPanel_inlineComponent1 extends RendererImageLabel implements IBindingClient
   {
      ...
      {
         FairyManagerPanel_inlineComponent1._watcherSetupUtil = param1;
      }
      ...
      public function set outerDocument(param1:FairyManagerPanel) : void
      {
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:FairyManagerPanel_inlineComponent1 = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _FairyManagerPanel_inlineComponent1_bindingsSetup();
         watchers = [];
         target = this;
