package com.qeedoo.ui.view.comp
{
   ...
   public class MCZDPetConfigCanvas extends Canvas implements IBindingClient
   {
      ...
      {
         MCZDPetConfigCanvas._watcherSetupUtil = param1;
      }
      ...
      {
         var _loc2_:MCZDPetFightConf = MCZDPetFightConf(_core.view.getUI(ViewManager.PANEL_MCZD_PETFIGHT_CONF));
      ...
      {
         var _loc2_:MCZDPetFightConf = null;
         if(pet.slotData)
         {
            _loc2_ = MCZDPetFightConf(_core.view.getUI(ViewManager.PANEL_MCZD_PETFIGHT_CONF));
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:MCZDPetConfigCanvas = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _MCZDPetConfigCanvas_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function ___MCZDPetConfigCanvas_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      private function showConfDetailPanel() : void
      {
         ...
         var _loc1_:MCZDPetAIConfPanel = MCZDPetAIConfPanel(_core.view.getUI(ViewManager.POP_MCZD_PET_PVE_AI_CONFIGURE));
