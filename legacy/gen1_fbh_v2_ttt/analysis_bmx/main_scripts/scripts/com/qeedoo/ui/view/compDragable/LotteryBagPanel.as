package com.qeedoo.ui.view.compDragable
{
   ...
   public class LotteryBagPanel extends DragableCanvas implements IBindingClient
   {
      ...
      {
         LotteryBagPanel._watcherSetupUtil = param1;
      }
      ...
      private function _LotteryBagPanel_bindingExprs() : void
      {
         ...
         _loc1_ = Language.LOTTERY_BAG_U[0];
         ...
         _loc1_ = Slot.SLOT_LOTTO;
         _loc1_ = Slot.SLOT_LOTTO;
         _loc1_ = Language.LOTTERY_BAG_U[6];
         _loc1_ = Language.LOTTERY_BAG_U[1];
         _loc1_ = Language.LOTTERY_BAG_U[3];
         _loc1_ = Language.LOTTERY_BAG_U[4];
      }
      ...
      private function _LotteryBagPanel_bindingsSetup() : Array
      {
         ...
         {
            var _loc1_:* = Language.LOTTERY_BAG_U[0];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LotteryBagPanel_BasicTitleCanvas1.text = param1;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTERY_BAG_U[6];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LotteryBagPanel_DescriptionLabel1.text = param1;
         },"_LotteryBagPanel_DescriptionLabel1.text");
         result[51] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTERY_BAG_U[1];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LotteryBagPanel_BasicGlowButton1.label = param1;
         },"_LotteryBagPanel_BasicGlowButton1.label");
         result[52] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTERY_BAG_U[3];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            getAll.label = param1;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTERY_BAG_U[4];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
      ...
      private function updateView() : void
      {
         ...
         while(_loc1_ < 50)
         {
            ...
            if(Boolean(_loc1_ < itemAC.length) && Boolean(itemAC[_loc1_]) && Boolean(itemAC[_loc1_].ti) && Boolean(itemAC[_loc1_].ii) && Boolean(itemAC[_loc1_].n))
            {
               ...
               {
                  _loc2_ = _core.data.getGameData(itemAC[_loc1_].ti,itemAC[_loc1_].ii);
                  _loc2_ && _loc2_.color && this["iSlot" + _loc1_].setStyleName(_loc2_.color);
               }
            }
            _loc1_++;
         }
      ...
      private function dClickHandler(param1:GameEvent) : void
      {
         ...
         if(Boolean(_loc2_ && _loc2_.slotData) && Boolean(!ToolKit.isEqual(_loc2_.giid,-1)) && !ToolKit.isEqual(_loc2_.type,-1))
         {
            ...
            _core.remote.call("getSingleLotteryItem",null,_loc3_);
         }
      }
      ...
      public function ___LotteryBagPanel_BasicGlowButton1_click(param1:MouseEvent) : void
      {
         init();
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:LotteryBagPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _LotteryBagPanel_bindingsSetup();
         watchers = [];
         target = this;
