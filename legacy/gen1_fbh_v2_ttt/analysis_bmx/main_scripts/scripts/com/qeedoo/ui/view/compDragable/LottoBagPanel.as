package com.qeedoo.ui.view.compDragable
{
   ...
   public class LottoBagPanel extends DragableCanvas implements IBindingClient
   {
      ...
      public var _LottoBagPanel_DescriptionLabel1:DescriptionLabel;
      ...
      public var _LottoBagPanel_BasicGlowButton1:BasicGlowButton;
      ...
      public var _LottoBagPanel_BasicTitleCanvas1:BasicTitleCanvas;
         ...
         "propertiesFactory":function():Object
         {
            return {
               ...
               "childDescriptors":[new UIComponentDescriptor({
                  ...
                  "id":"_LottoBagPanel_BasicTitleCanvas1"
                  ...
                  "id":"_LottoBagPanel_DescriptionLabel1",
                  "propertiesFactory":function():Object
                  {
                     return {
                        "x":280,
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           ...
                           "id":"_LottoBagPanel_BasicGlowButton1",
                           "events":{"click":"___LottoBagPanel_BasicGlowButton1_click"},
                           "propertiesFactory":function():Object
                           {
      ...
      public function LottoBagPanel()
      {
         ...
         this.x = 105;
         this.y = 231;
         this.addEventListener("creationComplete",___LottoBagPanel_DragableCanvas1_creationComplete);
      }
      
      public static function set watcherSetupUtil(param1:IWatcherSetupUtil) : void
      {
         LottoBagPanel._watcherSetupUtil = param1;
      }
      ...
      {
         _core.remote.call("getAllItem",null);
      }
      ...
      public function ___LottoBagPanel_BasicGlowButton1_click(param1:MouseEvent) : void
      {
         init();
      }
      ...
      private function lottoBagSort() : void
      {
         _core.remote.call("lottoBagSort",null);
      }
      ...
      public function ___LottoBagPanel_DragableCanvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      private function throwAllItemHandler(param1:CloseEvent) : void
      {
         ...
         {
            _core.remote.call("throwAllItem",null);
         }
      }
      ...
      {
         _core.remote.call("getLottoBag",null);
      ...
      private function dClickHandler(param1:GameEvent) : void
      {
         ...
         _core.remote.call("getSingleItem",null,_loc5_);
      }
      ...
      private function _LottoBagPanel_bindingsSetup() : Array
      {
         var binding:Binding = null;
         var result:Array = [];
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTO_BAG_U[0];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LottoBagPanel_BasicTitleCanvas1.text = param1;
         },"_LottoBagPanel_BasicTitleCanvas1.text");
         result[0] = binding;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTO_BAG_U[6];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LottoBagPanel_DescriptionLabel1.text = param1;
         },"_LottoBagPanel_DescriptionLabel1.text");
         result[51] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTO_BAG_U[1];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LottoBagPanel_BasicGlowButton1.label = param1;
         },"_LottoBagPanel_BasicGlowButton1.label");
         result[52] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTO_BAG_U[3];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            getAll.label = param1;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.LOTTO_BAG_U[4];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:LottoBagPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _LottoBagPanel_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_qeedoo_ui_view_compDragable_LottoBagPanelWatcherSetupUtil");
      ...
      private function _LottoBagPanel_bindingExprs() : void
      {
         var _loc1_:* = undefined;
         _loc1_ = Language.LOTTO_BAG_U[0];
         ...
         _loc1_ = Slot.SLOT_LOTTO;
         _loc1_ = Slot.SLOT_LOTTO;
         _loc1_ = Language.LOTTO_BAG_U[6];
         _loc1_ = Language.LOTTO_BAG_U[1];
         _loc1_ = Language.LOTTO_BAG_U[3];
         _loc1_ = Language.LOTTO_BAG_U[4];
      }
      ...
      private function drawPage(param1:int, param2:int) : void
      {
         ...
         while(_loc3_ < countPerPage)
         {
            ...
            if(_loc3_ < param2)
            {
               if(Boolean(itemAC[param1 + _loc3_]) && Boolean(itemAC[param1 + _loc3_].ti) && Boolean(itemAC[param1 + _loc3_].ii) && Boolean(itemAC[param1 + _loc3_].n))
               {
                  this["iSlot" + _loc3_].type = itemAC[param1 + _loc3_].ti;
                  this["iSlot" + _loc3_].giid = itemAC[param1 + _loc3_].ii;
                  this["iSlot" + _loc3_].stackNum = itemAC[param1 + _loc3_].n;
                  this["iSlot" + _loc3_].quality = itemAC[param1 + _loc3_].q;
                  this["iSlot" + _loc3_].slotData = itemAC[param1 + _loc3_];
                  if(itemAC[param1 + _loc3_].ti == GamePredef.TBL_CREATURE)
                  {
                     this["iSlot" + _loc3_].setStyleName(_core.basic.colorByGrowRate(itemAC[param1 + _loc3_].q / 10));
                  }
                  else
                  {
                     _loc4_ = _core.data.getGameData(itemAC[param1 + _loc3_].ti,itemAC[param1 + _loc3_].ii);
