package com.qeedoo.ui.view.comp
{
   ...
   public class ItemSlotMail extends ItemSlot implements IBindingClient
   {
      ...
      {
         ItemSlotMail._watcherSetupUtil = param1;
      }
               ...
               case SLOT_MAIL:
                  if(_loc2_.slotType == SLOT_BAG || _loc2_.slotType == SLOT_PET)
                  {
                     if(_loc2_.type == GamePredef.TBL_PET)
                     {
                        ...
                        {
                           _core.sysMidNote(Language.ITEMSLOTMAIL_S[0]);
                           return;
                        }
                     }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:ItemSlotMail = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _ItemSlotMail_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_qeedoo_ui_view_comp_ItemSlotMailWatcherSetupUtil");
      ...
      private function _ItemSlotMail_bindingExprs() : void
      {
         var _loc1_:* = undefined;
         _loc1_ = SLOT_MAIL;
      }
      
      private function _ItemSlotMail_bindingsSetup() : Array
      {
