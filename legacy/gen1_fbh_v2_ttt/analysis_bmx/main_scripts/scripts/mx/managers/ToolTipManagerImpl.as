package mx.managers
{
   ...
   public class ToolTipManagerImpl extends EventDispatcher implements IToolTipManager2
   {
      ...
      public function createToolTip(param1:String, param2:Number, param3:Number, param4:String = null, param5:IUIComponent = null) : IToolTip
      {
         ...
         var _loc7_:ISystemManager = param5 ? param5.systemManager : ApplicationGlobals.application.systemManager;
         _loc7_.toolTipChildren.addChild(_loc6_);
         if(param4)
         {
      ...
      mx_internal function positionTip() : void
      {
         ...
         if(isError)
         {
            _loc5_ = getGlobalBounds(currentTarget);
            ...
            if(_loc1_ + currentToolTip.width > _loc3_)
            {
               ...
               if(_loc1_ + currentToolTip.width + 4 > _loc3_)
               {
                  ...
                  _loc9_ = Number(Object(toolTipClass).maxWidth);
            ...
            _loc6_ = DisplayObject(_loc7_).root.globalToLocal(_loc6_);
            _loc1_ = _loc6_.x;
            _loc2_ = _loc6_.y;
         }
         else
         {
            ...
            _loc10_ = Number(currentToolTip.width);
            if(_loc1_ + _loc10_ > _loc3_)
            {
               _loc1_ = _loc3_ - _loc10_;
            }
            _loc11_ = Number(currentToolTip.height);
