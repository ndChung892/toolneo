package mx.managers
{
   ...
   public class LayoutManager extends EventDispatcher implements ILayoutManager
   {
      ...
      public function set usePhasedInstantiation(param1:Boolean) : void
      {
         ...
         if(_usePhasedInstantiation != param1)
         {
            _usePhasedInstantiation = param1;
            _loc2_ = SystemManagerGlobals.topLevelSystemManagers[0].stage;
            if(param1)
            {
               originalFrameRate = _loc2_.frameRate;
               _loc2_.frameRate = 1000;
            }
            else
            {
               _loc2_.frameRate = originalFrameRate;
            }
         }
      }
