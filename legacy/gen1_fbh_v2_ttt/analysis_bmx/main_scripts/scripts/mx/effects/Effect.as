   ...
   public class Effect extends EventDispatcher implements IEffect
   {
      ...
      public function captureStartValues() : void
      {
         ...
         if(targets.length > 0)
         {
            ...
            _loc1_ = int(targets.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               propertyChangesArray.push(new PropertyChanges(targets[_loc2_]));
               _loc2_++;
            }
      ...
      mx_internal function captureValues(param1:Array, param2:Boolean) : Array
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc3_:Array = !filterObject ? relevantProperties : mergeArrays(relevantProperties,filterObject.filterProperties);
         if(Boolean(_loc3_) && _loc3_.length > 0)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               _loc5_ = param1[_loc7_].target;
               _loc4_ = param2 ? param1[_loc7_].start : param1[_loc7_].end;
               _loc8_ = int(_loc3_.length);
               _loc9_ = 0;
               while(_loc9_ < _loc8_)
               {
                  _loc4_[_loc3_[_loc9_]] = getValueFromTarget(_loc5_,_loc3_[_loc9_]);
                  _loc9_++;
               }
               _loc7_++;
            }
         ...
         if((Boolean(_loc10_)) && _loc10_.length > 0)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               while(_loc9_ < _loc8_)
               {
                  _loc4_[_loc10_[_loc9_]] = _loc5_.getStyle(_loc10_[_loc9_]);
                  _loc9_++;
               }
               _loc7_++;
            }
      ...
      public function captureMoreStartValues(param1:Array) : void
      {
         ...
         if(param1.length > 0)
         {
            ...
            {
               _loc2_.push(new PropertyChanges(param1[_loc3_]));
               _loc3_++;
            }
            _loc2_ = captureValues(_loc2_,true);
      ...
      public function createInstance(param1:Object = null) : IEffectInstance
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc5_)
            {
               _loc6_ = int(propertyChangesArray.length);
               _loc7_ = 0;
               while(_loc7_ < _loc6_)
               {
