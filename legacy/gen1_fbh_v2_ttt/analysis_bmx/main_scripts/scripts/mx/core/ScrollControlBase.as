   ...
   public class ScrollControlBase extends UIComponent
   {
      ...
      protected function setScrollBarProperties(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ == ScrollPolicy.ON || param2 < param1 && param1 > 0 && _loc5_ == ScrollPolicy.AUTO)
         {
            ...
            if(Boolean(horizontalScrollBar) && Boolean(horizontalScrollBar.visible) && (numberOfCols != param1 || viewableColumns != param2 || scrollAreaChanged))
            {
         ...
         else if((Boolean(_loc5_ == ScrollPolicy.AUTO || _loc5_ == ScrollPolicy.OFF)) && Boolean(horizontalScrollBar) && horizontalScrollBar.visible)
         {
         ...
         if(_loc6_ == ScrollPolicy.ON || param4 < param3 && param3 > 0 && _loc6_ == ScrollPolicy.AUTO)
         {
            ...
            if(Boolean(verticalScrollBar) && Boolean(verticalScrollBar.visible) && (numberOfRows != param3 || viewableRows != param4 || scrollAreaChanged))
            {
         ...
         else if((Boolean(_loc6_ == ScrollPolicy.AUTO || _loc6_ == ScrollPolicy.OFF)) && Boolean(verticalScrollBar) && verticalScrollBar.visible)
         {
