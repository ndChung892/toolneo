package mx.core
{
   ...
   public class Repeater extends UIComponent implements IRepeater
   {
      ...
      {
         var _loc4_:UIComponentDescriptor = childDescriptors[param2];
         if(!_loc4_.document)
         {
            _loc4_.document = document;
         }
         _loc4_.instanceIndices = instanceIndices ? instanceIndices : [];
         _loc4_.instanceIndices.push(param1);
         _loc4_.repeaters = repeaters;
         _loc4_.repeaters.push(this);
         _loc4_.repeaterIndices = repeaterIndices;
         _loc4_.repeaterIndices.push(startingIndex + param1);
         _loc4_.invalidateProperties();
         var _loc5_:IFlexDisplayObject = Container(container).createComponentFromDescriptor(_loc4_,param3);
         _loc4_.instanceIndices = null;
         _loc4_.repeaters = null;
         _loc4_.repeaterIndices = null;
      ...
      private function removeAllChildRepeaters(param1:Container) : void
      {
         ...
         {
            _loc2_ = int(param1.childRepeaters.length);
            _loc3_ = int(_loc2_ - 1);
            while(_loc3_ >= 0)
            {
               _loc4_ = param1.childRepeaters[_loc3_];
      ...
      private function recycle() : void
      {
         ...
         if(Boolean(collection) && Boolean(collection.length > 0) && collection.length - startingIndex > 0)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               ...
               if(childDescriptors)
               {
                  ...
                  if(createdComponents.length >= (_loc2_ + 1) * _loc3_)
                  {
                     _loc4_ = 0;
                     while(_loc4_ < _loc3_)
                     {
                        _loc8_ = createdComponents[_loc2_ * _loc3_ + _loc4_];
                        if(_loc8_ is Repeater)
                        {
                  ...
                  else
                  {
                     ...
                     while(_loc4_ < _loc3_)
                     {
                        ...
                        createdComponents.push(_loc11_);
         ...
         _currentIndex = -1;
         _loc2_ = int(createdComponents.length - 1);
         while(_loc2_ >= _loc5_)
         {
            _loc12_ = createdComponents.pop();
      ...
      private function addItems(param1:int, param2:int) : void
      {
         ...
         _loc3_ = int(Math.max(startingIndex,param1));
         while(_loc3_ <= _loc5_)
         {
            ...
            while(_loc10_ < _loc9_)
            {
               ...
               createdComponents.push(_loc13_);
      ...
      private function get numCreatedChildren() : int
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < createdComponents.length)
         {
            _loc3_ = createdComponents[_loc2_];
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:int = int(param1.childRepeaters.length);
         while(_loc3_ < _loc4_)
         {
      ...
      private function getIndexForRepeater(param1:Repeater, param2:LocationInfo) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = int(createdComponents.length);
         while(_loc3_ < _loc4_)
         {
            _loc5_ = createdComponents[_loc3_];
            if(_loc5_ == param1)
            {
               param2.found = true;
               break;
            ...
            {
               _loc6_ = Repeater(_loc5_);
               _loc6_.getIndexForRepeater(param1,param2);
               if(param2.found)
               {
                  break;
               }
      ...
      private function removeItems(param1:int, param2:int) : void
      {
         ...
         {
            _loc3_ = int(createdComponents.length - 1);
            while(_loc3_ >= 0)
            {
               _loc4_ = createdComponents[_loc3_];
      ...
      private function getIndexForFirstChild() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:Array = Container(container).createdComponents;
         var _loc4_:int = _loc3_ ? int(_loc3_.length) : 0;
         while(_loc2_ < _loc4_)
         {
            _loc5_ = Container(container).createdComponents[_loc2_];
            if(_loc5_ == this)
            {
               _loc1_.found = true;
               break;
            ...
            {
               _loc6_ = Repeater(_loc5_);
               _loc6_.getIndexForRepeater(this,_loc1_);
               if(_loc1_.found)
               {
                  break;
               }
      ...
      public function get currentIndex() : int
      {
         ...
         if(_currentIndex == -1)
         {
            _loc1_ = resourceManager.getString("core","notExecuting");
      ...
      private function updateItems(param1:int, param2:int) : void
      {
         ...
         if(recycleChildren)
         {
            ...
            while(_loc4_ < _loc3_)
            {
               ...
               _loc6_ = getRepeaterIndex(_loc5_);
               if(_loc6_ != -1 && param1 <= _loc6_ && _loc6_ <= param2)
               {
