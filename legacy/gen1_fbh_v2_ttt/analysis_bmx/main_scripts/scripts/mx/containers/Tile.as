package mx.containers
{
   ...
   public class Tile extends Container
   {
      ...
      override protected function measure() : void
      {
         ...
         if(_loc5_ > 0)
         {
            ...
            if(direction == TileDirection.HORIZONTAL)
            {
               ...
               if(!isNaN(_loc15_))
               {
                  _loc13_ = Math.floor(_loc15_ / (cellWidth + _loc11_));
               }
            }
            else
            {
               ...
               if(!isNaN(_loc16_))
               {
                  _loc13_ = Math.floor(_loc16_ / (cellHeight + _loc12_));
               }
            }
            if(isNaN(_loc13_))
            {
      ...
      private function setChildSize(param1:IUIComponent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_ > cellWidth)
            {
               ...
               _loc2_ = _loc4_ > cellWidth || _loc5_ > cellWidth ? Math.max(_loc5_,_loc4_) : cellWidth;
            }
         }
         ...
         else
         {
            ...
            if(_loc3_ > cellHeight)
            {
               ...
               _loc3_ = _loc4_ > cellHeight || _loc5_ > cellHeight ? Math.max(_loc5_,_loc4_) : cellHeight;
            }
         }
      ...
      mx_internal function findCellSize() : void
      {
         ...
         var _loc1_:Boolean = !isNaN(tileWidth);
         var _loc2_:Boolean = !isNaN(tileHeight);
         if(_loc1_ && _loc2_)
         {
            cellWidth = tileWidth;
         ...
         cellWidth = _loc1_ ? tileWidth : _loc3_;
         cellHeight = _loc2_ ? tileHeight : _loc4_;
      }
