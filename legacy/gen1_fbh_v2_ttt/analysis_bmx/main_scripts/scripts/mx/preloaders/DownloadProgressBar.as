package mx.preloaders
{
   ...
   public class DownloadProgressBar extends Sprite implements IPreloaderDisplay
   {
      ...
      protected function rslErrorHandler(param1:RSLEvent) : void
      {
         ...
         var _loc2_:ErrorField = new ErrorField(this.parent);
...
class ErrorField extends Sprite
{
   ...
   public function ErrorField(param1:DisplayObjectContainer)
   {
      super();
   ...
   public function show(param1:String) : void
   {
      ...
      var _loc2_:Stage = parentContainer.stage;
      var _loc3_:TextField = new TextField();
      _loc3_.autoSize = TextFieldAutoSize.LEFT;
      _loc3_.multiline = true;
      _loc3_.wordWrap = true;
      _loc3_.background = true;
      _loc3_.defaultTextFormat = labelFormat;
      _loc3_.text = param1;
      _loc3_.width = Math.max(MIN_WIDTH_INCHES * Capabilities.screenDPI,_loc2_.stageWidth - TEXT_MARGIN_PX * 2);
      _loc3_.width = Math.min(MAX_WIDTH_INCHES * Capabilities.screenDPI,_loc3_.width);
      _loc3_.y = Math.max(0,_loc2_.stageHeight - TEXT_MARGIN_PX - _loc3_.height);
      _loc3_.x = (_loc2_.stageWidth - _loc3_.width) / 2;
