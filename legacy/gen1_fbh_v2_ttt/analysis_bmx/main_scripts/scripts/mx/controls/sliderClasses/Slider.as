   ...
   public class Slider extends UIComponent
   {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(directionChanged)
         {
            ...
            if(labelObjects)
            {
               _loc4_ = int(labelObjects.numChildren - 1);
               while(_loc4_ >= 0)
               {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc3_:Boolean = _direction == SliderDirection.HORIZONTAL;
      ...
      private function positionDataTip(param1:Object) : void
      {
         ...
         if(_direction == SliderDirection.HORIZONTAL)
         {
            ...
            if(_loc6_ == "left")
            {
               _loc2_ -= _loc7_ + dataTip.width;
               _loc3_ += (param1.height - dataTip.height) / 2;
            }
            ...
            {
               _loc3_ -= _loc7_ + dataTip.height;
               _loc2_ -= (dataTip.width - param1.width) / 2;
            }
         ...
         else
         {
            ...
            {
               _loc3_ -= _loc7_ + (dataTip.height + param1.width) / 2;
               _loc2_ -= (dataTip.width - param1.height) / 2;
            }
            else if(_loc6_ == "bottom")
            {
               _loc3_ += _loc7_ + (dataTip.height + param1.width) / 2;
         ...
         dataTip.x = _loc9_.x < 0 ? 0 : _loc9_.x;
         dataTip.y = _loc9_.y < 0 ? 0 : _loc9_.y;
      }
      ...
      private function createLabels() : void
      {
         ...
         if(labelObjects)
         {
            _loc2_ = int(labelObjects.numChildren - 1);
            while(_loc2_ >= 0)
            {
      ...
      private function layoutTicks() : void
      {
         ...
         if(ticks)
         {
            ...
            _loc5_ = _loc4_ / 2;
            _loc7_ = getStyle("tickColor");
            _loc8_ = Boolean(_tickValues) && _tickValues.length > 0 ? true : false;
            _loc9_ = 0;
            _loc10_ = _loc8_ ? Number(_tickValues[_loc9_++]) : minimum;
            _loc1_.clear();
            if(_tickInterval > 0 || _loc8_)
            {
               _loc1_.lineStyle(_loc4_,_loc7_,100);
               do
               {
                  _loc6_ = Math.round(getXFromValue(_loc10_) - _loc5_);
                  _loc1_.moveTo(_loc6_,_loc2_);
                  _loc1_.lineTo(_loc6_,0);
               }
               while(_loc10_ = _loc8_ ? (_loc9_ < _tickValues.length ? Number(_tickValues[_loc9_++]) : NaN) : _tickInterval + _loc10_, _loc10_ < maximum || _loc8_ && _loc9_ < _tickValues.length);
               if(!_loc8_ || _loc10_ == maximum)
               {
                  _loc6_ = track.x + track.width - 1 - _loc5_;
                  _loc1_.moveTo(_loc6_,_loc2_);
                  _loc1_.lineTo(_loc6_,0);
               }
      ...
      private function getComponentBounds() : Object
      {
         ...
         var _loc1_:Boolean = direction == SliderDirection.HORIZONTAL;
         var _loc2_:int = labelObjects ? labelObjects.numChildren : 0;
         var _loc4_:Number = 0;
         var _loc6_:Number = 0;
      ...
      private function setValueAt(param1:Number, param2:int, param3:Boolean = false) : void
      {
         ...
         if(!param3)
         {
            ...
            if(!isNaN(_loc4_) && Math.abs(_loc4_ - param1) > 0.002)
            {
