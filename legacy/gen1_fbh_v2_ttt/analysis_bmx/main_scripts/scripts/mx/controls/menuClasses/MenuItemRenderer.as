package mx.controls.menuClasses
{
   ...
   public class MenuItemRenderer extends UIComponent implements IDataRenderer, IListItemRenderer, IMenuItemRenderer, IDropInListItemRenderer, IFontContextComponent
   {
      ...
      {
         var _loc1_:Number = getStyle("horizontalGap");
         return branchIcon ? branchIcon.measuredWidth + _loc1_ : 0;
      }
      
      public function get measuredIconWidth() : Number
      {
         var _loc1_:Number = getStyle("horizontalGap");
         return _icon ? _icon.measuredWidth + _loc1_ : 0;
      }
      ...
      override protected function measure() : void
      {
         ...
         if(_listData)
         {
            ...
            _loc5_ = Math.max(getStyle("leftIconGap"),_loc4_ ? _loc1_ + _loc2_ : Math.max(_loc1_,_loc2_));
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(_listData)
         {
            ...
            _loc7_ = Math.max(getStyle("leftIconGap"),_loc6_ ? _loc3_ + _loc4_ : Math.max(_loc3_,_loc4_));
