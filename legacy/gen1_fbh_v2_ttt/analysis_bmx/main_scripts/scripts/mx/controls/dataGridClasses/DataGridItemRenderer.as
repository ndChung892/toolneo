package mx.controls.dataGridClasses
{
   ...
   public class DataGridItemRenderer extends UITextField implements IDataRenderer, IDropInListItemRenderer, ILayoutManagerClient, IListItemRenderer, IStyleClient
   {
      ...
      protected function toolTipShowHandler(param1:ToolTipEvent) : void
      {
         ...
         _loc3_ = stage.globalToLocal(_loc3_);
         _loc2_.move(_loc3_.x,_loc3_.y + (height - _loc2_.height) / 2);
         var _loc4_:Rectangle = systemManager.screen;
         var _loc5_:Number = _loc4_.x + _loc4_.width;
         if(_loc2_.x + _loc2_.width > _loc5_)
         {
            _loc2_.move(_loc5_ - _loc2_.width,_loc2_.y);
         }
      }
