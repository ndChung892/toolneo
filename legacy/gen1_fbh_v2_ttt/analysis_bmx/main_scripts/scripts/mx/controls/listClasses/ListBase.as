package mx.controls.listClasses
{
   ...
   public class ListBase extends ScrollControlBase implements IDataRenderer, IFocusManagerComponent, IListItemRenderer, IDropInListItemRenderer, IEffectTargetHost
   {
      ...
      mx_internal function createItemMask(param1:Number, param2:Number, param3:Number, param4:Number) : DisplayObject
      {
      ...
      protected function drawItem(param1:IListItemRenderer, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc12_ = runningDataEffect ? param1.y - cachedPaddingTop : Number(_loc9_[_loc11_.rowIndex].y);
      ...
      override public function get baselinePosition() : Number
      {
         ...
         var _loc1_:Boolean = dataProvider == null;
         ...
         var _loc3_:IUIComponent = listItems[0][0] as IUIComponent;
         if(!_loc3_)
         {
            return super.baselinePosition;
         }
         var _loc4_:ListBaseContentHolder = ListBaseContentHolder(_loc3_.parent);
         var _loc5_:Number = _loc4_.y + _loc3_.y + _loc3_.baselinePosition;
         if(_loc1_ || _loc2_)
         {
            if(_loc1_)
            {
         ...
         if(_loc2_ == listContent)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               if(listItems[_loc6_].length)
               {
                  ...
                  {
                     _loc7_ = int(listItems[_loc6_].length);
                     if(_loc7_ == 1)
                     {
