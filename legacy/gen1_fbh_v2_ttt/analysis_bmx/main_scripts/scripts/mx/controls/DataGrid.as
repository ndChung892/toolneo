package mx.controls
{
   ...
   public class DataGrid extends DataGridBase implements IIMESupport
   {
      ...
      override protected function mouseUpHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(_loc3_) && Boolean(_loc3_ != itemEditorInstance) && lastItemDown == _loc3_)
         {
            ...
            if(Boolean((_loc7_) && _loc7_.y >= 0) && Boolean(editable) && !dontEdit)
            {
               ...
               {
                  _loc2_ = new DataGridEvent(DataGridEvent.ITEM_EDIT_BEGINNING,false,true);
                  _loc2_.columnIndex = displayableColumns[_loc7_.x].colNum;
                  _loc2_.dataField = displayableColumns[_loc7_.x].dataField;
         ...
         else if(Boolean(lastItemDown) && lastItemDown != itemEditorInstance)
         {
            ...
            if(Boolean((_loc7_) && _loc7_.y >= 0) && Boolean(editable) && !dontEdit)
            {
               if(displayableColumns[_loc7_.x].editable)
               {
                  ...
                  _loc2_.dataField = displayableColumns[_loc7_.x].dataField;
                  _loc2_.rowIndex = _loc7_.y;
                  _loc2_.itemRenderer = lastItemDown;
                  dispatchEvent(_loc2_);
               }
               else
               {
      ...
      private function itemEditorItemEditEndHandler(param1:DataGridEvent) : void
      {
         ...
         if(!param1.isDefaultPrevented())
         {
            ...
            if(Boolean(itemEditorInstance) && param1.reason != DataGridEventReason.CANCELLED)
            {
               ...
               if(_loc4_ != null && _loc5_[_loc4_] !== _loc3_)
               {
                  _loc2_ = true;
      ...
      override protected function makeRowsAndColumns(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:int, param7:Boolean = false, param8:uint = 0) : Point
      {
         ...
         if(itemEditorInstance)
         {
            ...
            _loc10_ = editedItemPosition.columnIndex < lockedColumnCount ? visibleLockedColumns[actualColIndex] : visibleColumns[actualColIndex];
      ...
      private function scrollToEditedItem(param1:int, param2:int) : void
      {
         ...
         var _loc6_:uint = Boolean(_loc3_) && Boolean(_loc3_[0]) ? uint(_loc3_[0].length) : visibleColumns.length;
         var _loc7_:int = horizontalScrollPosition + _loc6_ - 1 + lockedColumnCount;
         var _loc8_:int = _loc3_[0][_loc6_ - 1].x + _loc3_[0][_loc6_ - 1].width > listContent.width ? 1 : 0;
         if(param2 > lockedColumnCount)
         {
            ...
            else
            {
               while(param2 > _loc7_ || Boolean(param2 == _loc7_ && param2 > horizontalScrollPosition + lockedColumnCount) && Boolean(_loc8_))
               {
                  ...
                  _loc6_ = Boolean(_loc3_) && Boolean(_loc3_[0]) ? uint(_loc3_[0].length) : visibleColumns.length;
      ...
      private function findNextEnterItemRenderer(param1:KeyboardEvent) : void
      {
         ...
         var _loc5_:DataGridEvent = new DataGridEvent(DataGridEvent.ITEM_EDIT_BEGINNING,false,true);
      ...
      private function findNextItemRenderer(param1:Boolean) : Boolean
      {
         ...
         while(!_loc4_)
         {
            ...
            if(Boolean(_columns[_loc3_].editable) && Boolean(_columns[_loc3_].visible))
            {
               ...
               {
                  _loc8_ = new DataGridEvent(DataGridEvent.ITEM_EDIT_BEGINNING,false,true);
                  _loc8_.columnIndex = _loc3_;
                  _loc8_.dataField = _columns[_loc3_].dataField;
                  _loc8_.rowIndex = _loc2_;
      ...
      override protected function focusInHandler(param1:FocusEvent) : void
      {
         ...
         if(param1.target != this)
         {
            ...
            {
               if(_loc3_ is IListItemRenderer && _loc3_.parent.parent == this && _loc3_.parent is ListBaseContentHolder)
               {
                  if(_loc3_.visible)
                  {
                     break;
            ...
            if(_loc3_)
            {
               _loc4_ = itemRendererToIndices(IListItemRenderer(_loc3_));
               if(Boolean((_loc4_) && _loc4_.y >= 0) && Boolean(editable) && Boolean(displayableColumns[_loc4_.x].editable) && !dontEdit)
               {
                  _loc2_ = new DataGridEvent(DataGridEvent.ITEM_EDIT_BEGINNING,false,true);
                  _loc2_.columnIndex = displayableColumns[_loc4_.x].colNum;
                  _loc2_.dataField = displayableColumns[_loc4_.x].dataField;
                  _loc2_.rowIndex = _loc4_.y;
                  _loc2_.itemRenderer = IListItemRenderer(_loc3_);
                  dispatchEvent(_loc2_);
               }
            }
            return;
         ...
         if(editable && !isPressed)
         {
            ...
            {
               _loc2_ = new DataGridEvent(DataGridEvent.ITEM_EDIT_BEGINNING,false,true);
               _loc2_.columnIndex = _editedItemPosition.columnIndex;
               _loc2_.dataField = _columns[_editedItemPosition.columnIndex].dataField;
               _loc2_.rowIndex = _editedItemPosition.rowIndex;
               dispatchEvent(_loc2_);
            }
         }
      }
      ...
      public function createItemEditor(param1:int, param2:int) : void
      {
         ...
         if(!_loc3_.rendererIsEditor)
         {
            ...
            if(!itemEditorInstance)
            {
               _loc11_ = _loc3_.itemEditor;
               _loc7_ = _loc3_.editorXOffset;
               _loc8_ = _loc3_.editorYOffset;
               _loc9_ = _loc3_.editorWidthOffset;
               _loc10_ = _loc3_.editorHeightOffset;
               itemEditorInstance = _loc11_.newInstance();
            ...
            itemEditorInstance.move(_loc4_.x + _loc7_,_loc5_.y + _loc8_);
            itemEditorInstance.setActualSize(Math.min(_loc3_.width + _loc9_,actualContentHolder.width - 1 - itemEditorInstance.x),Math.min(_loc5_.height + _loc10_,actualContentHolder.height - itemEditorInstance.y));
      ...
      mx_internal function calculateHeaderHeight() : Number
      {
         ...
         if(showHeaders)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               ...
               if(_loc2_.visible)
               {
                  _loc1_ = _loc2_.getMeasuringRenderer(true,_loc2_);
                  ...
                  _loc4_ = Math.max(_loc4_,_explicitHeaderHeight ? headerHeight : _loc1_.getExplicitOrMeasuredHeight() + _loc8_ + _loc7_);
      ...
      private function calculateColumnSizes() : void
      {
            ...
            else
            {
               ...
               while(_loc3_ < _loc2_)
               {
                  if(!(_loc3_ >= lockedColumnCount && _loc3_ < lockedColumnCount + horizontalScrollPosition))
                  {
                     ...
                     if(_loc3_ < lockedColumnCount)
                     {
                        lockedColumnWidth += isNaN(_loc5_.explicitWidth) ? _loc5_.preferredWidth : _loc5_.explicitWidth;
                        visibleLockedColumns.push(_loc5_);
                     }
                     else
                     {
                     ...
                     _loc4_ += isNaN(_loc5_.explicitWidth) ? _loc5_.preferredWidth : _loc5_.explicitWidth;
         ...
         if(horizontalScrollPolicy == ScrollPolicy.OFF)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               if(Boolean(visibleColumns[_loc3_].resizable) && !visibleColumns[_loc3_].newlyVisible)
               {
                  ...
                  {
                     _loc11_ += visibleColumns[_loc3_].width;
                  }
                  else
                  {
                     _loc10_++;
                     _loc11_ += visibleColumns[_loc3_].minWidth;
                  }
               }
               else
               {
               ...
               _loc4_ += visibleColumns[_loc3_].width;
               _loc3_++;
            }
            _loc2_ = int(visibleLockedColumns.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               if(Boolean(visibleLockedColumns[_loc3_].resizable) && !visibleLockedColumns[_loc3_].newlyVisible)
               {
                  ...
                  {
                     _loc11_ += visibleLockedColumns[_loc3_].width;
                  }
                  else
                  {
                     _loc10_++;
                     _loc11_ += visibleLockedColumns[_loc3_].minWidth;
                  }
               }
               else
               {
               ...
               _loc4_ += visibleLockedColumns[_loc3_].width;
               _loc3_++;
            }
            ...
            if(displayWidth > _loc11_ && Boolean(_loc10_))
            {
               ...
               while(_loc3_ < _loc2_)
               {
                  if(Boolean(visibleLockedColumns[_loc3_].resizable) && Boolean(!visibleLockedColumns[_loc3_].newlyVisible) && isNaN(visibleLockedColumns[_loc3_].explicitWidth))
                  {
                     ...
                     _loc14_ = Number(visibleLockedColumns[_loc3_].minWidth);
                     visibleLockedColumns[_loc3_].setWidth(_loc8_ > _loc14_ ? _loc8_ : _loc14_);
                  }
                  _loc13_ -= visibleLockedColumns[_loc3_].width;
               ...
               while(_loc3_ < _loc2_)
               {
                  if(Boolean(visibleColumns[_loc3_].resizable) && Boolean(!visibleColumns[_loc3_].newlyVisible) && isNaN(visibleColumns[_loc3_].explicitWidth))
                  {
                     ...
                     _loc8_ = _loc7_.width - (_loc4_ - displayWidth) * _loc12_;
                     _loc14_ = Number(visibleColumns[_loc3_].minWidth);
                     visibleColumns[_loc3_].setWidth(_loc8_ > _loc14_ ? _loc8_ : _loc14_);
                  }
                  _loc13_ -= visibleColumns[_loc3_].width;
         ...
         else
         {
            ...
            while(_loc3_ < _loc2_)
            {
               ...
               _loc4_ += isNaN(visibleColumns[_loc3_].explicitWidth) ? visibleColumns[_loc3_].preferredWidth : visibleColumns[_loc3_].explicitWidth;
               _loc3_++;
            }
            if(visibleColumns.length == 0)
            {
            ...
            else if(_loc4_ < displayWidth - lockedColumnWidth && horizontalScrollPosition > 0)
            {
               while(_loc4_ < displayWidth - lockedColumnWidth && horizontalScrollPosition > 0)
               {
                  ...
                  _loc6_ = isNaN(_loc5_.explicitWidth) ? _loc5_.preferredWidth : _loc5_.explicitWidth;
            ...
            _loc6_ = isNaN(_loc7_.explicitWidth) ? _loc7_.preferredWidth : _loc7_.explicitWidth;
      ...
      override protected function configureScrollBars() : void
      {
         ...
         var _loc8_:* = (_loc7_) && _loc4_ > 0 ? int(listItems[0].length) : int(visibleColumns.length);
         if(_loc7_ && _loc4_ > 0 && _loc8_ > 1 && visibleColumns[_loc8_ - 1] == displayableColumns[displayableColumns.length - 1] && listItems[0][_loc8_ - 1].x + visibleColumns[_loc8_ - 1].width > displayWidth - listContent.x + viewMetrics.left)
         {
            _loc8_--;
         }
         else if(_loc8_ > 1 && !_loc7_ && visibleColumns[_loc8_ - 1] == displayableColumns[displayableColumns.length - 1])
         {
            _loc9_ = 0;
            _loc10_ = 0;
            while(_loc10_ < visibleColumns.length)
            {
               _loc9_ += visibleColumns[_loc10_].width;
               _loc10_++;
            }
      ...
      override public function set horizontalScrollPosition(param1:Number) : void
      {
         ...
         if(_loc2_ != param1)
         {
            ...
            if(headerVisible && Boolean(header))
            {
      ...
      protected function drawColumnBackground(param1:Sprite, param2:int, param3:uint, param4:DataGridColumn) : void
      {
         ...
         var _loc9_:Number = Number(_loc8_.rendererArray[param2].x);
      ...
      override protected function calculateRowHeight(param1:Object, param2:Number, param3:Boolean = false) : Number
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:int = int(visibleLockedColumns.length);
      ...
      protected function drawVerticalLine(param1:Sprite, param2:int, param3:uint, param4:Number) : void
      {
         ...
         _loc6_.moveTo(param4,headerVisible ? 0 : 1);
         _loc6_.lineTo(param4,_loc5_.height);
      }
      
      private function editorMouseDownHandler(param1:MouseEvent) : void
      {
         if(!owns(DisplayObject(param1.target)))
         {
            endEdit(DataGridEventReason.OTHER);
         }
      }
