package mx.controls.scrollClasses
{
   ...
   public class ScrollBar extends UIComponent
   {
      ...
      private function scrollTrack_mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         _loc2_ = param1.target.localToGlobal(_loc2_);
         ...
         trackScrollRepeatDirection = scrollThumb.y + scrollThumb.height < _loc2_.y ? 1 : (scrollThumb.y > _loc2_.y ? -1 : 0);
      ...
      public function set scrollPosition(param1:Number) : void
      {
         ...
         if(scrollThumb)
         {
            ...
            if(!isScrolling)
            {
               ...
               _loc3_ = _loc2_ == 0 || isNaN(_loc2_) ? 0 : (param1 - minScrollPosition) * (trackHeight - scrollThumb.height) / _loc2_ + trackY;
      ...
      private function scrollTrack_mouseLeaveHandler(param1:Event) : void
      {
         ...
         var _loc2_:String = oldPosition > scrollPosition ? pageMinusDetail : pagePlusDetail;
         dispatchScrollEvent(oldPosition,_loc2_);
         oldPosition = NaN;
      }
