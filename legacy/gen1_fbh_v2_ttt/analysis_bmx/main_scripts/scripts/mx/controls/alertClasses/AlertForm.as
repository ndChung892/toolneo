package mx.controls.alertClasses
{
   ...
   public class AlertForm extends UIComponent implements IFontContextComponent
   {
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(!param1 || param1 == "styleName" || param1 == "buttonStyleName")
         {
            if(buttons)
            {
               ...
               _loc3_ = int(buttons.length);
               _loc4_ = 0;
               while(_loc4_ < _loc3_)
               {
                  buttons[_loc4_].styleName = _loc2_;
                  _loc4_++;
               }
            }
         }
      ...
      override protected function measure() : void
      {
         ...
         var _loc3_:int = Math.max(buttons.length,2);
         var _loc4_:Number = _loc3_ * buttons[0].width + (_loc3_ - 1) * 8;
         var _loc5_:Number = Math.max(_loc4_,_loc2_.width);
         textField.width = 2 * _loc5_;
         ...
         if(textWidth < _loc6_ && textField.multiline == true)
         {
         ...
         _loc7_ = _loc7_ + (buttons[0].height + 3 * 8);
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         _loc4_ = param2 - buttons[0].height;
         _loc5_ = buttons.length * (buttons[0].width + 8) - 8;
         _loc3_ = (param1 - _loc5_) / 2;
         var _loc6_:int = 0;
         while(_loc6_ < buttons.length)
         {
            buttons[_loc6_].move(_loc3_,_loc4_);
            buttons[_loc6_].tabIndex = _loc6_ + 1;
            _loc3_ += buttons[_loc6_].width + 8;
            _loc6_++;
         }
         _loc5_ = textWidth;
         if(icon)
         ...
         var _loc7_:Number = Number(textField.getExplicitOrMeasuredHeight());
         textField.move(_loc3_,(_loc4_ - _loc7_) / 2);
         textField.setActualSize(textWidth + 5,_loc7_);
      }
