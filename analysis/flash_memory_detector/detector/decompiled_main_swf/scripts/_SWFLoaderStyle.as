package
{
   ...
   public class _SWFLoaderStyle
   {
      ...
      private static var _embed_css_Assets_swf___brokenImage_978669412:Class = _SWFLoaderStyle__embed_css_Assets_swf___brokenImage_978669412;
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         if(style.defaultFactory == null)
         {
            style.defaultFactory = function():void
            {
               ...
               this.brokenImageSkin = _embed_css_Assets_swf___brokenImage_978669412;
