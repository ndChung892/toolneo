package mx.core
{
   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, ISimpleStyleClient, IStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IStateClient, IConstraintClient
   {
      ...
      override public function addChild(param1:DisplayObject) : DisplayObject
      {
         ...
         var _loc3_:int = Boolean(overlayReferenceCount) && param1 != overlay ? int(Math.max(0,super.numChildren - 1)) : super.numChildren;
         addingChild(param1);
      ...
      public function setStyle(param1:String, param2:*) : void
      {
         ...
         var _loc4_:Boolean = inheritingStyles != UIComponent.STYLE_UNINITIALIZED;
         var _loc5_:Boolean = getStyle(param1) != param2;
         if(!_styleDeclaration)
         {
      ...
      {
         if(Boolean(param1 && param1.instanceIndices) && Boolean(!_instanceIndices) && !param1.isDocument)
         {
      ...
      private function callLaterDispatcher2(param1:Event) : void
      {
         ...
         var _loc2_:ISystemManager = systemManager;
         if(Boolean(_loc2_) && Boolean(_loc2_.stage) && listeningForRender)
         {
      ...
      {
         var _loc1_:int = int(_effectsStarted.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
