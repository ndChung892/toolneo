package com.qeedoo.ui.view.comp
{
   ...
   public class PetPVEConfigCanvas extends Canvas implements IBindingClient
   {
      ...
      public function PetPVEConfigCanvas()
      {
         super();
         ...
         this.addEventListener("creationComplete",___PetPVEConfigCanvas_Canvas1_creationComplete);
      }
      
      public static function set watcherSetupUtil(param1:IWatcherSetupUtil) : void
      {
         PetPVEConfigCanvas._watcherSetupUtil = param1;
      }
      ...
      public function ___PetPVEConfigCanvas_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      {
         var _loc2_:PetPVEConfigPanel = PetPVEConfigPanel(_core.view.getUI(ViewManager.PANEL_PET_PVE_CONFIG));
      ...
      {
         var _loc2_:PetPVEConfigPanel = null;
         if(pet.slotData)
         {
            _loc2_ = PetPVEConfigPanel(_core.view.getUI(ViewManager.PANEL_PET_PVE_CONFIG));
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:PetPVEConfigCanvas = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _PetPVEConfigCanvas_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_qeedoo_ui_view_comp_PetPVEConfigCanvasWatcherSetupUtil");
      ...
      private function _PetPVEConfigCanvas_bindingsSetup() : Array
      {
      ...
      private function showConfDetailPanel() : void
      {
         ...
         var _loc1_:PetPVEAIConfPanel = PetPVEAIConfPanel(_core.view.getUI(ViewManager.POP_PET_PVE_AI_CONFIGURE));
      ...
      private function _PetPVEConfigCanvas_bindingExprs() : void
      {
