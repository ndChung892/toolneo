package com.qeedoo.ui.view.comp
{
   ...
   public class AIConfPetArenaActPanel extends DragableCanvas implements IBindingClient
   {
      ...
      public var _AIConfPetArenaActPanel_BasicTitleCanvas1:BasicTitleCanvas;
      ...
      public var _AIConfPetArenaActPanel_BasicGlowButton2:BasicGlowButton;
      
      private var _3645t1:Tile;
      
      public var _AIConfPetArenaActPanel_BasicGlowButton1:BasicGlowButton;
      ...
      public var _AIConfPetArenaActPanel_BasicTxtButton1:BasicTxtButton;
      
      public var _AIConfPetArenaActPanel_BasicTxtButton2:BasicTxtButton;
      
      public var _AIConfPetArenaActPanel_BasicTxtButton3:BasicTxtButton;
      
      public var _AIConfPetArenaActPanel_BasicTxtButton4:BasicTxtButton;
      ...
      private var _parent:PetConfigCanvasActivity;
         ...
         "propertiesFactory":function():Object
         {
            return {
               ...
               "childDescriptors":[new UIComponentDescriptor({
                  ...
                  "id":"_AIConfPetArenaActPanel_BasicTitleCanvas1"
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           "type":BasicTxtButton,
                           "id":"_AIConfPetArenaActPanel_BasicTxtButton1",
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           "type":BasicTxtButton,
                           "id":"_AIConfPetArenaActPanel_BasicTxtButton2",
                           "stylesFactory":function():void
                           {
                              this.horizontalCenter = "0";
                           },
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           "type":BasicTxtButton,
                           "id":"_AIConfPetArenaActPanel_BasicTxtButton3",
                           "stylesFactory":function():void
                           {
                              this.horizontalCenter = "0";
                           },
                           ...
                           "type":BasicTxtButton,
                           "id":"_AIConfPetArenaActPanel_BasicTxtButton4",
                           "stylesFactory":function():void
                           {
                              this.bottom = "3";
                              this.left = "5";
                           ...
                           "id":"_AIConfPetArenaActPanel_BasicGlowButton1",
                           "events":{"click":"___AIConfPetArenaActPanel_BasicGlowButton1_click"},
                           "stylesFactory":function():void
                           {
                              this.right = "20";
                              this.bottom = "3";
                           ...
                           "type":BasicGlowButton,
                           "id":"_AIConfPetArenaActPanel_BasicGlowButton2",
                           "events":{"click":"___AIConfPetArenaActPanel_BasicGlowButton2_click"},
                           "stylesFactory":function():void
                           {
                              this.right = "60";
                              this.bottom = "3";
      ...
      public function AIConfPetArenaActPanel()
      {
         ...
         this.addEventListener("creationComplete",___AIConfPetArenaActPanel_DragableCanvas1_creationComplete);
      }
      
      public static function set watcherSetupUtil(param1:IWatcherSetupUtil) : void
      {
         AIConfPetArenaActPanel._watcherSetupUtil = param1;
      }
      ...
      public function ___AIConfPetArenaActPanel_DragableCanvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      public function ___AIConfPetArenaActPanel_BasicGlowButton1_click(param1:MouseEvent) : void
      {
         savePetConf();
      }
      ...
      private function _AIConfPetArenaActPanel_bindingsSetup() : Array
      {
         ...
         {
            _AIConfPetArenaActPanel_BasicTitleCanvas1.text = param1;
         },"_AIConfPetArenaActPanel_BasicTitleCanvas1.text");
         result[0] = binding;
         binding = new Binding(this,function():String
         {
         ...
         {
            _AIConfPetArenaActPanel_BasicTxtButton1.label = param1;
         },"_AIConfPetArenaActPanel_BasicTxtButton1.label");
         result[1] = binding;
         binding = new Binding(this,function():String
         {
         ...
         {
            _AIConfPetArenaActPanel_BasicTxtButton2.text = param1;
         },"_AIConfPetArenaActPanel_BasicTxtButton2.text");
         result[2] = binding;
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.AI_CONF_PANEL_U[1];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            tg1.label = param1;
         ...
         binding = new Binding(this,function():String
         {
            var _loc1_:* = Language.AI_CONF_PANEL_U[11];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            tg1.toolTip = param1;
         ...
         {
            _AIConfPetArenaActPanel_BasicTxtButton3.text = param1;
         },"_AIConfPetArenaActPanel_BasicTxtButton3.text");
         result[15] = binding;
         ...
         {
            _AIConfPetArenaActPanel_BasicTxtButton4.text = param1;
         },"_AIConfPetArenaActPanel_BasicTxtButton4.text");
         result[40] = binding;
         binding = new Binding(this,function():String
         {
         ...
         {
            _AIConfPetArenaActPanel_BasicGlowButton1.label = param1;
         },"_AIConfPetArenaActPanel_BasicGlowButton1.label");
         result[41] = binding;
         binding = new Binding(this,function():String
         {
         ...
         {
            _AIConfPetArenaActPanel_BasicGlowButton2.label = param1;
         },"_AIConfPetArenaActPanel_BasicGlowButton2.label");
         result[42] = binding;
         return result;
      }
      ...
      private function setTarget(param1:Event) : void
      {
         ...
         if(Boolean(_selectedSlot) && _selectedSlot.giid > 0)
         {
            ...
            else
            {
               ...
               _selectedSlot.tarType = Language.AI_CONF_PANEL_U[20] + Language.AI_CONF_PANEL_U[_loc2_];
            }
            clearDraw();
            _core.nextGuide(ViewManager.POP_AI_CONFIGURE_ACTIVITY,"",-1,-1,3);
         }
      }
      ...
      private function savePetConf() : void
      {
         ...
         var _loc1_:PetFightConfActivity = PetFightConfActivity(_core.view.getUI(ViewManager.PANEL_PETFIGHT_CONF_ACTIVITY));
         var _loc2_:* = _loc1_.getCacheConfData(petId);
         ...
         _encapsulatedConfData.creatureData = _loc2_.creatureData;
         var _loc3_:Number = 24;
         var _loc4_:Array = [];
         var _loc5_:* = int(_loc3_ - 1);
         while(_loc5_ >= 0)
         {
            _loc6_ = this["confSlot" + _loc5_];
            if(_loc6_)
            {
               if(_loc6_.giid >= 0)
               {
                  ...
                  if(_loc6_.type == GamePredef.TBL_SKILL)
                  {
                     _loc8_ = _core.data.gameData[GamePredef.TBL_SKILL][_loc6_.giid];
                     if(_loc8_)
                     {
                        _loc7_.action = GamePredef.BATTLE_ACTION_SKILL;
                        _loc7_.level = _loc8_.level;
                        _loc7_.id = _loc8_.id;
                        if(_skillTargetTemp[_loc8_.id])
                        {
                           _loc7_.t = _skillTargetTemp[_loc8_.id];
                        }
                     }
                  }
         ...
         _encapsulatedConfData.cmdList = _loc4_;
         _loc1_.saveConfData(_encapsulatedConfData);
         _parent.conf = _encapsulatedConfData;
         this.hide();
         _core.nextGuide(ViewManager.POP_AI_CONFIGURE_ACTIVITY,"",-1,-1,4);
      }
      ...
      public function showPanel(param1:int, param2:Number, param3:PetConfigCanvasActivity, param4:Object = null) : void
      {
      ...
      private function _AIConfPetArenaActPanel_bindingExprs() : void
      {
         var _loc1_:* = undefined;
         _loc1_ = Language.PETFIGHT_PANEL_U[1];
         _loc1_ = Language.AI_CONF_PANEL_U[0];
         _loc1_ = Language.AI_CONF_PANEL_U[10];
         _loc1_ = Language.AI_CONF_PANEL_U[1];
         _loc1_ = Language.AI_CONF_PANEL_U[11];
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:AIConfPetArenaActPanel = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _AIConfPetArenaActPanel_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_qeedoo_ui_view_comp_AIConfPetArenaActPanelWatcherSetupUtil");
      ...
      public function ___AIConfPetArenaActPanel_BasicGlowButton2_click(param1:MouseEvent) : void
      {
         showAIHelp();
      }
      ...
      private function putSlot(param1:Event) : void
      {
         ...
         if(_selectedSlot)
         {
            _core.nextGuide(ViewManager.POP_AI_CONFIGURE_ACTIVITY,"",-1,-1,2);
            _loc3_ = _core.view.getUI(ViewManager.POP_NEW_PLAER_GUIDE);
            if(_loc3_.visible)
            {
               drawGuideFrame();
            }
      ...
      private function onPageChanged(param1:int, param2:int) : void
      {
         ...
         while(_loc4_ < param2)
         {
            ...
            this["s" + _loc4_].tarType = Language.AI_CONF_PANEL_U[20] + Language.AI_CONF_PANEL_U[_loc6_];
            _loc4_++;
         }
      }
      ...
      private function onSkillListClick(param1:MouseEvent) : void
      {
         ...
         if(_loc2_)
         {
            _core.nextGuide(ViewManager.POP_AI_CONFIGURE_ACTIVITY,"",-1,-1,1);
