package com.qeedoo.ui.view.comp
{
   ...
   public class ThreeDiabetesBox extends Canvas
   {
      ...
      public function ___ThreeDiabetesBox_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         init();
      }
      ...
      public function setType(param1:int) : void
      {
         ...
         if(type >= 0 && type <= 4)
         {
            ...
            if(this.bomb)
            {
               _loc2_.ty = bm.bitmapData.height - ThreeDiabetes.rects[5].height;
               bm.bitmapData.draw(ThreeDiabetes.rects[5],_loc2_);
            }
            else if(this.num == 2)
            {
               _loc2_.ty = bm.bitmapData.height - ThreeDiabetes.rects[6].height;
               bm.bitmapData.draw(ThreeDiabetes.rects[6],_loc2_);
            }
            return;
         }
         visible = false;
