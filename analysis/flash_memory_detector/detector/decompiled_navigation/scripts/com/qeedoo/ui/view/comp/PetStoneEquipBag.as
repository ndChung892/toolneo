package com.qeedoo.ui.view.comp
{
   ...
   public class PetStoneEquipBag extends Canvas implements IBindingClient
   {
      ...
      {
         PetStoneEquipBag._watcherSetupUtil = param1;
      }
      
      public function ___PetStoneEquipBag_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         initView();
      }
      ...
      public function ___PetStoneEquipBag_BasicGlowButton1_click(param1:MouseEvent) : void
      {
         getPetEquiptData();
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:PetStoneEquipBag = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _PetStoneEquipBag_bindingsSetup();
         watchers = [];
         target = this;
      ...
      private function _PetStoneEquipBag_bindingExprs() : void
      {
         ...
         _loc1_ = Slot.SLOT_PET_STONE_EQUIP_BAG;
         _loc1_ = Slot.SLOT_PET_STONE_EQUIP_BAG;
         _loc1_ = Slot.SLOT_PET_STONE_EQUIP_BAG;
         _loc1_ = Slot.SLOT_PET_STONE_EQUIP_BAG;
         _loc1_ = Slot.SLOT_PET_STONE_EQUIP_BAG;
      ...
      public function getPetEquiptData() : void
      {
         ...
         var _loc4_:int = int(GamePredef.TBL_EQUIPT_INSTANCE);
         if(Boolean(_dm.bagSlotIndex) && Boolean(_dm.bagSlotIndex[_loc4_]))
         {
            for(_loc5_ in _dm.bagSlotIndex[_loc4_])
            {
               _loc2_ = _dm.bagSlotIndex[_loc4_][_loc5_];
               _loc6_ = _core.getTemplateData(_loc4_ + 1,Number(_loc5_),false);
               if(GamePredef.ITEM_KIND_PETEQU == Number(_loc6_.kind))
               {
                  for(_loc7_ in _loc2_)
                  {
                     _loc3_ = _dm.sList[_loc2_[_loc7_]];
                     if(Boolean(_loc3_) && _core.data.isBagSlot(Number(_loc3_.sid)))
                     {
                        _loc8_ = _dm.getGameData(_loc3_.type,_loc3_.itemId);
                        _loc9_ = new Object();
                        if(_loc8_)
                        {
                        ...
                        _loc9_.slotData = _loc3_;
                        _loc9_.type = _loc3_.type;
                        _loc9_.giid = _loc3_.itemId;
                        _loc9_.stackNum = _loc3_.stackNum;
                        _loc1_.push(_loc9_);
                     }
                  }
               }
         ...
         _loc1_.sortOn("color",Array.NUMERIC);
         updatePage(_loc1_);
      }
      ...
      public function updatePage(param1:Object = null) : void
      {
         ...
         var _loc3_:Number = (_curPage - 1) * PAGE_NUM;
         var _loc4_:int = 0;
         while(_loc4_ < PAGE_NUM)
         {
            ...
            {
               _loc7_ = _bagData[_loc3_ + _loc4_];
               _loc6_.type = _loc7_.type;
               _loc6_.giid = _loc7_.giid;
               _loc6_.slotData = _loc7_;
               _loc6_.stackNum = _loc7_.stackNum;
            }
            _loc4_++;
         }
      }
