package com.qeedoo.ui.view.comp
{
   ...
   public class VDAYMoveCanva extends Canvas implements IBindingClient
   {
      ...
      {
         VDAYMoveCanva._watcherSetupUtil = param1;
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:VDAYMoveCanva = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _VDAYMoveCanva_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function updateData() : void
      {
         ...
         _loc1_ = _core.fetchVDAYWish(info);
         if(_loc1_)
         {
            RL_receiver.text = "to:" + _loc1_.targetName;
            RL_sender.text = "from:" + _loc1_.name;
            TA.htmlText = _loc1_.wish;
