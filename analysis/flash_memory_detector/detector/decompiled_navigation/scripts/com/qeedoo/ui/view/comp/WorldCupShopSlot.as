package com.qeedoo.ui.view.comp
{
   ...
   public class WorldCupShopSlot extends SimpleCanvas implements ISlot, IBindingClient
   {
      ...
      {
         WorldCupShopSlot._watcherSetupUtil = param1;
      }
      ...
      public function ___WorldCupShopSlot_DelayButton1_click(param1:MouseEvent) : void
      {
         buyWorldCupItem();
      }
      ...
      private function buyWorldCupItem() : void
      {
         ...
         object = _core.view.getUI(ViewManager.PANEL_WORLD_CUP);
      ...
      public function setLimit(param1:Number) : void
      {
         limit.text = "剩余:(" + ToolKit.minus(shopSlotVO.stackMax,param1) + "/" + shopSlotVO.stackMax + ")";
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:WorldCupShopSlot = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _WorldCupShopSlot_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function ___WorldCupShopSlot_SimpleCanvas1_creationComplete(param1:FlexEvent) : void
      {
         initView();
      }
