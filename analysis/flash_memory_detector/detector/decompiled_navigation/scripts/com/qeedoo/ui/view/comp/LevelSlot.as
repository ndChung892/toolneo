package com.qeedoo.ui.view.comp
{
   ...
   public class LevelSlot extends Canvas implements ISlot, IBindingClient
   {
      ...
      {
         LevelSlot._watcherSetupUtil = param1;
      }
      ...
      private function set level(param1:int) : void
      {
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:LevelSlot = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(_documentDescriptor_);
         bindings = _LevelSlot_bindingsSetup();
         watchers = [];
         target = this;
      ...
      private function insReturn(param1:Object) : void
      {
         ...
         if(Boolean(_loc2_) && Boolean(_loc2_.id))
         {
            if(ToolKit.isEqual(_loc2_.binded,1))
            {
               ...
               _loc4_ = _core.player.petList[_loc2_.id];
               if(_loc4_)
               {
                  _loc4_.inTrade = false;
                  _loc4_.inAuction = false;
               }
               clean();
               _core.view.getUI(ViewManager.PANEL_BAG).petInit();
               return;
            }
            _loc3_ = _dm.getData(GamePredef.TBL_CREATURE,_loc2_.tid);
            ...
            {
               _core.remote.call("gdc",new Responder(tmpReturn),GamePredef.TBL_CREATURE,_loc2_.tid);
            }
         }
      }
      ...
      private function _LevelSlot_bindingsSetup() : Array
      {
         ...
         {
            var _loc1_:* = Language.LEVEL_SLOT_U[0];
            return _loc1_ == undefined ? null : String(_loc1_);
         },function(param1:String):void
         {
            _LevelSlot_BasicTxtButton1.label = param1;
         ...
         {
            _LevelSlot_RoundedLabel1.text = param1;
         ...
         {
            _LevelSlot_RoundedLabel2.text = param1;
      ...
      private function _LevelSlot_bindingExprs() : void
      {
         ...
         _loc1_ = Language.LEVEL_SLOT_U[0];
      ...
      {
         if(param2 <= 0 || param1 != GamePredef.TBL_PET)
         {
            return;
         }
