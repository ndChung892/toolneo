/* Address: 0077d4c0 | Ghidra name: FUN_0077d4c0 */

void __fastcall FUN_0077d4c0(int param_1)

{
  ...
  if (*(int *)(param_1 + 4) == 0) {
    ...
    *(undefined4 *)(param_1 + 4) = 0xffffffff;
    ...
    local_10 = FUN_0077a680(&PTR_DAT_01c0f488,5000,&PTR_DAT_01be7764);
    if ((*(uint *)(local_10 + 0x1c) & 0x1600000) == 0) {
      *(undefined4 *)(param_1 + 4) = 0;
      FUN_00eaeca8();
      FUN_00d92980(&PTR_DAT_01545534);
