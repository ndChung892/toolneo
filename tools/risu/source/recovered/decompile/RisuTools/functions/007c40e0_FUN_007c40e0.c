/* Address: 007c40e0 | Ghidra name: FUN_007c40e0 */

void __fastcall FUN_007c40e0(int param_1)
...
LAB_007c4707:
  ...
  iStack_18 = FUN_007877c0(1,1,*(undefined4 *)(*(int *)(*(int *)(param_1 + 4) + 0x108) + 0x34),
                           DAT_018d5208,DAT_018d5200);
  if ((*(uint *)(iStack_18 + 0x1c) & 0x1600000) == 0) {
...
LAB_007c44db:
    ...
    if (*(int *)(iStack_1c + 0x20) != 0) {
      if (*(int *)(DAT_01c289c4 + 0x68) == 0) {
        FUN_00eae9a0();
        FUN_00e999ee(in_stack_ffffffa8);
        in_stack_ffffffa8 = 0x7c453c;
        FUN_00eaec14();
      }
...
LAB_007c4404:
        ...
        if (*(int *)(iStack_1c + 0x20) == 0) {
          ...
          if (*(int *)(DAT_01c289c4 + 0x6c) == 0) {
            FUN_00eae9a0();
            FUN_00e999ff(in_stack_ffffffa8);
            in_stack_ffffffa8 = 0x7c4a38;
            FUN_00eaec14();
          }
...
LAB_007c432c:
          ...
          if (*(int *)(iStack_1c + 0x20) == 0) {
            ...
            if (*(int *)(DAT_01c289c4 + 0x70) == 0) {
              FUN_00eae9a0();
              FUN_00e99a10(in_stack_ffffffa8);
              in_stack_ffffffa8 = 0x7c4b56;
              FUN_00eaec14();
            }
...
LAB_007c412f:
    ...
    if (*(int *)(local_14 + 0x20) != 0) {
      if (*(int *)(DAT_01c289c4 + 0x74) == 0) {
        FUN_00eae9a0();
        FUN_00e99a21(in_stack_ffffffa8);
        in_stack_ffffffa8 = 0x7c418d;
        FUN_00eaec5e();
      }
      iVar3 = FUN_00e4d760();
      if (iVar3 != 0) {
