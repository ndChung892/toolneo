/* Address: 007a1960 | Ghidra name: FUN_007a1960 */

void __fastcall FUN_007a1960(int *param_1)
...
LAB_007a19ae:
  ...
  if (*(int *)(iVar7 + 0x20) == 0) {
    ...
    if (*(int *)(DAT_01c289ac + 0x3c) == 0) {
      FUN_00eae9a0();
      FUN_00e9926d(in_stack_ffffffd4);
      FUN_00eaec14();
    }
...
LAB_007a1c45:
    ...
    piVar5[8] = 0;
switchD_007a199a_caseD_1:
    piVar5 = param_1;
    if (local_14 != 1) goto LAB_007a1b19;
    iVar6 = param_1[9];
    param_1[9] = 0;
    param_1[2] = -1;
    do {
