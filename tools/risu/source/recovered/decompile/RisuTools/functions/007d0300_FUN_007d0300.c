/* Address: 007d0300 | Ghidra name: FUN_007d0300 */

void __fastcall FUN_007d0300(int *param_1)
...
LAB_007d04cd:
    ...
    if ((*(int *)(local_18 + 0x20) != 0) &&
       (iVar1 = *(int *)(*(int *)(local_18 + 0x20) + 0x10), 0 < *(int *)(iVar1 + 8))) {
      iVar1 = *(int *)(iVar1 + 4);
      if (*(int *)(iVar1 + 4) == 0) goto LAB_007d08b5;
...
LAB_007d03fa:
      ...
      if (*(int *)(local_18 + 0x20) == 0) {
        ...
        if (*(int *)(DAT_01c289cc + 0x6c) == 0) {
          FUN_00eae9a0();
          FUN_00e99f60(param_1);
          FUN_00eaec14();
        }
