/* Address: 007ba280 | Ghidra name: FUN_007ba280 */

void __fastcall FUN_007ba280(int *param_1)

{
  ...
  if ((*(int *)(local_14 + 0x20) != 0) &&
    ...
    iVar1 = *(int *)(iVar1 + 4);
    if (*(int *)(iVar1 + 4) == 0) goto LAB_007ba8be;
...
LAB_007ba3ef:
      ...
      if (*(int *)(local_14 + 0x20) != 0) {
        if (*(int *)(iVar2 + 8) == 0) {
          FUN_00eae9a0();
          FUN_00e99d95(in_stack_ffffffd8);
          FUN_00eaec14();
        }
...
LAB_007ba318:
            ...
            if (*(int *)(local_14 + 0x20) == 0) {
              ...
              if (*(int *)(DAT_01c289c4 + 0x5c) == 0) {
                FUN_00eae9a0();
                FUN_00e999bb(piVar4);
                piVar4 = (int *)0x7ba836;
                FUN_00eaebef();
              }
              iVar1 = FUN_00e4e4a0(&PTR_DAT_01543d24,&local_20);
            }
            if (iVar1 != 0) {
              FUN_0077ab40(0,*(undefined4 *)(iVar1 + 8),&PTR_DAT_01ba04a8);
              local_18 = FUN_00975000(*(undefined4 *)(*(int *)(iVar2 + 4) + 0x1c));
