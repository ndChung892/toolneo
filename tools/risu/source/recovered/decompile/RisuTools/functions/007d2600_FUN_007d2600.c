/* Address: 007d2600 | Ghidra name: FUN_007d2600 */

void __fastcall FUN_007d2600(int *param_1)
...
LAB_007d264e:
  ...
  if (*(int *)(iVar7 + 0x20) == 0) {
    ...
    if (*(int *)(DAT_01c289cc + 0x94) == 0) {
      FUN_00eae9a0();
      FUN_00e9a00a(in_stack_ffffffd4);
      FUN_00eaec14();
    }
...
LAB_007d28eb:
    ...
    piVar5[8] = 0;
switchD_007d263a_caseD_1:
    piVar5 = param_1;
    if (local_14 != 1) goto LAB_007d27bf;
    iVar6 = param_1[9];
    param_1[9] = 0;
    param_1[2] = -1;
    do {
